...
const dir = path.join(baseDir, 'src', 'app', 'admin', 'teaching-assignments');
fs.mkdirSync(dir, { recursive: true });

fs.writeFileSync(path.join(dir, 'page.tsx'), `"use server"
...
console.log('TeachingAssignments module generated');
