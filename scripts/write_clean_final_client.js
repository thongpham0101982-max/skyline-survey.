...
const clientPath = path.join(rootDir, 'src', 'app', 'teacher', 'du-gio-gvnn', 'client.tsx');

// We will write client.tsx in 3 clean slices using fs.writeFileSync and fs.appendFileSync

const slice1 = `"use client";
...
fs.writeFileSync(clientPath, slice1, 'utf8');
console.log('Slice 1 written');
