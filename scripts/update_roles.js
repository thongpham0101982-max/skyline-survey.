...
sidebarC = sidebarC.replace(/{ href: "\/admin\/achievements", label: "Thành tích Học sinh", icon: GraduationCap, module: "ANY" },/, `{ href: "/admin/student-info", label: "Thành tích Học sinh", icon: GraduationCap, module: "STUDENT_ACHIEVEMENTS" },`);
