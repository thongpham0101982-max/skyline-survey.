...
* **Các file thực hiện**:
  ...
  * `[MODIFY]` [`src/components/Sidebar.tsx`](file:///d:/SSM/skyline-survey/src/components/Sidebar.tsx): Thêm menu **"7. Công việc & Báo cáo tuần"** với badge hiển thị số việc cần tiếp nhận.
...
*Tài liệu đã được lưu trữ thành công tại thư mục gốc dự án: `BAO_CAO_CONG_VIEC_LUONG_VA_KE_HOACH.md`.*
