  ...
  return (
    <div className="relative inline-block text-left" ref={ref}>
      <button 
        ...
        className="relative p-2 rounded-xl text-slate-600 hover:text-[#00A99D] hover:bg-slate-100/80 transition-all focus:outline-none"
      >
                  ...
                  >
                    <div className="flex items-start justify-between gap-2 mb-1">
                      <h4 className="font-bold text-slate-800 text-xs flex items-center gap-1.5 leading-snug">
                        <CheckCircle2 className="w-3.5 h-3.5 text-[#00A99D] shrink-0" />
                        {n.title}
                      </h4>
                    ...
                    {n.link && (
                      <div className="mt-1.5 pl-5 flex items-center text-[10px] text-[#00A99D] font-medium gap-1">
