...
const buttonVariants = cva(
  "inline-flex items-center justify-center font-medium tracking-normal select-none whitespace-nowrap transition-all duration-200 outline-none disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-offset-2 cursor-pointer",
  {
    variants: {
      variant: {
        default: "bg-[#003B3A] text-white hover:bg-[#004D4B] active:bg-[#002827] focus-visible:ring-[#003B3A] shadow-xs",
        primary: "bg-[#003B3A] text-white hover:bg-[#004D4B] active:bg-[#002827] focus-visible:ring-[#003B3A] shadow-xs",
        ...
        link: "text-[#003B3A] underline-offset-4 hover:underline p-0 h-auto font-medium",
      },
      size: {
        default: "h-9 px-4 py-2 text-xs rounded-xl gap-2",
        xs: "h-7 px-2.5 text-[11px] rounded-lg gap-1.5",
        sm: "h-8 px-3 text-xs rounded-lg gap-1.5",
        md: "h-9 px-4 py-2 text-xs rounded-xl gap-2",
