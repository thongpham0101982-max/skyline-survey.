...
export function WelcomeAlert({ name }: { name: string }) {
  ...
  return (
    <div className="mb-5 animate-in fade-in slide-in-from-top-4 duration-500">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#003B3A] to-[#1E8B87] p-0.5 shadow-md">
        ...
        <div className="relative bg-white/10 backdrop-blur-md rounded-lg p-4 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <button onClick={() => setIsModalOpen(true)} className="flex-1 md:flex-none text-[#003B3A] font-bold text-xs shadow-sm hover:bg-slate-50 transition-all flex items-center justify-center gap-1.5 text-xs font-semibold">
