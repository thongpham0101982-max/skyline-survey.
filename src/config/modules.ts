...
export const APP_CATEGORIES = [
  ...
  },
  {
    ...
    modules: [
      { code: "MANAGE_SURVEYS", name: "Quản lý Khảo sát", icon: FileSpreadsheet, href: "/admin/surveys" },`r`n      { code: "SURVEY_ANALYTICS", name: "Phân tích NPS", icon: PieChart, href: "/admin/nps" },
