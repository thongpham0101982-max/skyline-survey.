  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 p-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-4 border-b border-[#D9E2EC] pb-6">
        ...
        <div>
          <h1 className="text-3xl font-black text-[#004C97] tracking-tight">Danh sách Kỳ thi</h1>
          <p className="text-slate-500 mt-1 font-medium">Quản lý danh sách, cấu hình và lịch thi của học sinh</p>
        </div>
      </div>
