  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 p-6 animate-in fade-in duration-500">
      ...
      <div className="flex items-center gap-4 border-b border-[#D9E2EC] pb-6">
        ...
        <div>
          <h1 className="text-3xl font-black text-[#004C97] tracking-tight">Đăng ký Dự thi</h1>
          <p className="text-slate-500 mt-1 font-medium">Quản lý hồ sơ đăng ký, danh sách thí sinh và số báo danh dự thi</p>
        </div>
      </div>
