...
export function SkyLineSwooshBg() {
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden z-0 select-none">
      ...
      <svg className="absolute -bottom-12 -left-12 w-[135%] h-[48%] text-[#48BFE3]" viewBox="0 0 1000 350" fill="none">
        ...
        <defs>
          <linearGradient id="image2-swoosh-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            ...
            <stop offset="40%" stopColor="#48BFE3" stopOpacity="0.25" />
        ...
        {roles.map((r) => {
          ...
          return (
            <button
              ...
              className={`flex items-center justify-center gap-1.5 py-2.5 px-2 rounded-xl text-xs font-extrabold transition-all duration-200 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#48BFE3]/40 ${
                isActive
                  ? 'bg-[#48BFE3] text-white shadow-md shadow-teal-600/30 scale-[1.02]'
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={loading}
        className="w-full h-[50px] mt-1 bg-[#48BFE3] hover:bg-[#009085] active:scale-[0.99] text-white rounded-2xl text-sm font-extrabold shadow-lg shadow-teal-600/25 hover:shadow-xl hover:shadow-teal-600/35 flex items-center justify-center gap-2 transition-all duration-200 disabled:opacity-60 disabled:pointer-events-none focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#48BFE3]/30 cursor-pointer"
      >
        {loading ? (
          <>
