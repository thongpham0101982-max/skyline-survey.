  ...
  if (!portalStatus.checked) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-slate-50">
        <Loader2 className="w-12 h-12 text-[#48BFE3] animate-spin mb-4" />
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-teal-50 via-slate-50 to-amber-50 relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-[500px] my-8">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-[#48BFE3] rounded-3xl mb-4 shadow-2xl relative animate-bounce-subtle">
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleVerify} className="space-y-5">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      className="w-full rounded-2xl px-5 py-4 bg-slate-50 border-2 border-transparent focus:bg-white focus:border-[#48BFE3] text-base font-extrabold text-slate-800 outline-none transition-all placeholder:text-slate-300" 
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full rounded-2xl pl-14 pr-5 py-4 bg-slate-50 border-2 border-transparent focus:bg-white focus:border-[#48BFE3] text-base font-extrabold text-slate-800 outline-none transition-all" 
                    />
                  </div>
                </div>
                ...
                <button 
                  type="submit" 
                  disabled={verifying}
                  className="w-full py-4.5 bg-[#48BFE3] hover:bg-[#009085] text-white rounded-2xl text-base font-black shadow-xl shadow-[#48BFE3]/20 flex items-center justify-center gap-2 transition-all active:scale-98 disabled:opacity-50"
                >
                  {verifying ? (
                    <>
          ...
          {studentInfo && !uploadSuccess && (
            <div className="space-y-6">
              ...
              <div className="bg-slate-50 p-5 rounded-2xl border border-slate-100 space-y-2">
                <span className="text-[9px] text-[#48BFE3] font-black uppercase tracking-widest block">Thông tin học sinh</span>
                ...
                <div className="grid grid-cols-2 gap-2 text-xs font-bold text-slate-500 pt-1">
                  ...
                  <div className="col-span-2 mt-1">Mã số: <span className="text-[#48BFE3] font-black">{studentInfo.studentCode}</span></div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div 
                  ...
                  className="border-2 border-dashed border-slate-200 hover:border-[#48BFE3] bg-slate-50 rounded-3xl p-6 flex flex-col items-center justify-center min-h-[220px] cursor-pointer transition-all relative overflow-hidden group"
                >
                  <input 
                    type="file" 
                    ref={fileInputRef} 
                  ...
                  {previewUrl ? (
                    ...
                    <div className="text-center space-y-3">
                      <div className="inline-flex items-center justify-center w-14 h-14 bg-white text-slate-400 group-hover:text-[#48BFE3] rounded-2xl shadow transition-colors">
                  ...
                  <button 
                    ...
                    className={`flex-1 py-4 text-white rounded-2xl text-sm font-black shadow-xl transition-all flex items-center justify-center gap-2 ${
                      selectedFile && !uploading 
                        ? "bg-[#48BFE3] hover:bg-[#009085] shadow-[#48BFE3]/20 active:scale-98" 
