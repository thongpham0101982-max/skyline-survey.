...
<div style="padding:32px 12px;background:#f1f5f9;">
  <div style="max-width:860px;margin:0 auto;background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 10px 30px rgba(0,122,135,.1);border:1px solid #e2e8f0;">
    ...
    <!-- HEADER -->
    <div style="background-color: #36E08F; background: linear-gradient(135deg, #36E08F 0%, #007A87 100%); padding: 35px 30px; text-align: center; border-bottom: 3px solid #007A87;">
    ...
    <div style="padding:10px 32px 30px 32px;">
      <h2 style="font-size:15px;font-weight:800;color:#1E1B4B;border-left:4px solid #36E08F;padding-left:12px;margin:0 0 16px;text-transform:uppercase;letter-spacing:0.5px;">Danh sách kết quả học sinh</h2>
    ...
    <div style="padding: 10px 32px 30px 32px; text-align: center;">
      ...
      <a href="${baseUrl}/admin/xet-duyet-ket-qua" style="display: inline-block; padding: 12px 28px; border-radius: 12px; font-size: 14px; font-weight: bold; color: #ffffff; background-color: #36E08F; text-decoration: none; border: 1px solid #007A87; box-shadow: 0 4px 6px -1px rgba(0, 166, 169, 0.2); margin-bottom: 25px;">
