  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">Theo dõi tiến độ khảo sát của các lớp do bạn phụ trách.</p>
      </div>
      ...
      <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-12 text-center flex flex-col items-center justify-center">
        ...
        <p className="text-indigo-700/80 max-w-md mx-auto">
          Mô-đun Quản lý Khảo sát cấp độ lớp học đang được hoàn thiện. Dữ liệu sẽ được trích xuất và liên kết với các lớp do bạn chủ nhiệm hoặc giảng dạy trong các bản cập nhật tới.
        </p>
      </div>
    </div>
  )
