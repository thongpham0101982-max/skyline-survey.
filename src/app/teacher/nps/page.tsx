  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto pb-12">
      <div>
        ...
        <p className="text-slate-500 mt-1">Chỉ số thuộc năm học mặc định: <span className="font-bold text-[#48BFE3]">{activeYear?.name || 'N/A'}</span></p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
        <div className="bg-white rounded-xl p-6 shadow-sm border-2 border-violet-100 col-span-1 md:col-span-3 flex flex-col items-center justify-center py-12">
           ...
           <div className="text-6xl font-black text-[#48BFE3] mb-4">{nps}</div>
