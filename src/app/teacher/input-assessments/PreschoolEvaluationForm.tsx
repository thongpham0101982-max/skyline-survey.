...
export default function PreschoolEvaluationForm({
  ...
  return (
    <div className="flex flex-col h-full min-h-screen text-xs font-semibold">
      {/* Premium Header */}
      <div className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 px-6 py-4 flex justify-between items-center shadow-sm">
        ...
        <button
          onClick={onClose}
          className="hover:bg-rose-50 hover:text-rose-600 text-slate-600 font-bold transition-all flex items-center gap-2 text-sm text-xs font-semibold"
        >
      ...
      <div className="flex-1 p-4 md:p-6 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-3 gap-6 pb-24">
        ...
        <div className="lg:col-span-2 space-y-6">
          {isAssessmentLocked && (
            <div className="text-emerald-800 flex items-start gap-3 shadow-sm text-xs font-semibold">
                          ...
                          {isPhysical ? (
                            <div className="flex flex-col md:flex-row md:items-center gap-4">
                              ...
                              <div className="flex items-center bg-white border-2 border-violet-100 rounded-2xl overflow-hidden hover:border-violet-300 focus-within:border-violet-500 focus-within:ring-4 focus-within:ring-violet-100/30 transition-all shadow-sm max-w-[200px]">
                                ...
                                />
                                <div className="text-sm font-black text-violet-600 select-none min-w-[48px] text-center text-xs font-semibold">
                                  {unit}
                                </div>
                              </div>
                              ...
                              <div className="flex-1">
                                <input
                                  ...
                                  disabled={isAssessmentLocked}
                                  className="w-full outline-none focus:border-pink-400 focus:bg-white text-sm font-medium text-slate-700 transition-all disabled:opacity-70 disabled:cursor-not-allowed text-xs font-semibold"
                                />
                              </div>
                            </div>
                          ) : (
                            <div className="space-y-2">
                              ...
                              <input
                                ...
                                disabled={isAssessmentLocked}
                                className="w-full outline-none focus:border-pink-400 focus:bg-white text-xs font-medium text-slate-700 transition-all disabled:opacity-70 disabled:cursor-not-allowed text-xs font-semibold"
                              />
                            </div>
                          )}
                        </div>
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    disabled={isAssessmentLocked}
                    className="w-full p-3 outline-none focus:border-pink-400 focus:bg-white text-sm font-medium text-slate-700 transition-all disabled:opacity-70 disabled:cursor-not-allowed text-xs font-semibold"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    disabled={isAssessmentLocked}
                    rows={4}
                    className="w-full p-3 outline-none focus:border-pink-400 focus:bg-white text-sm font-medium text-slate-700 transition-all resize-none disabled:opacity-70 disabled:cursor-not-allowed text-xs font-semibold"
                  />
                </div>
              ...
              <div className="space-y-4">
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    disabled={isAssessmentLocked}
                    className="w-full p-3 outline-none focus:border-pink-400 focus:bg-white text-sm font-medium text-slate-700 transition-all h-24 resize-none disabled:opacity-70 disabled:cursor-not-allowed text-xs font-semibold"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    disabled={isAssessmentLocked}
                    className="w-full p-3 outline-none focus:border-pink-400 focus:bg-white text-sm font-medium text-slate-700 transition-all h-20 resize-none disabled:opacity-70 disabled:cursor-not-allowed text-xs font-semibold"
                  />
                </div>
