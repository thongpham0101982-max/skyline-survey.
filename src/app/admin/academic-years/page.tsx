    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
        ...
        <form action={createAcademicYear} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
          ...
          <button type="submit" className="w-full bg-[#00A19A] text-white font-bold py-2.5 px-4 rounded-xl hover:bg-[#008c85] transition-colors shadow-md shadow-indigo-500/20">
            Tạo Năm học
          </button>
        </form>
      </div>
