    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border-2 border-blue-100">
        ...
        <form action={createAcademicYear} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
          ...
          <button type="submit" className="w-full bg-[#36E08F] text-white font-bold py-2.5 px-4 rounded-xl hover:bg-[#009085] transition-colors shadow-md shadow-indigo-500/20">
            Tạo Năm học
          </button>
        </form>
      </div>
