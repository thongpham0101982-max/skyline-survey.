                    ...
                    <td className="pr-6 py-5">
                      <div className="flex justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <Tooltip label="Kết quả">
                           <Link href={"/admin/surveys/"+s.id+"/results"} className="p-2 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg"><BarChart3 className="w-4 h-4" /></Link>
                        </Tooltip>
                        <Tooltip label="Xóa">
            ...
            return (
              <div key={s.id} className="bg-white rounded-3xl border border-slate-200 p-6 hover:shadow-xl transition-all group relative overflow-hidden">
                ...
                <div className="grid grid-cols-3 gap-2 mt-auto">
                   ...
                   <Link href={"/admin/surveys/"+s.id+"/results"} className="flex items-center justify-center gap-1.5 py-2.5 bg-slate-100 hover:bg-indigo-600 hover:text-white rounded-xl text-xs font-bold transition-all">
