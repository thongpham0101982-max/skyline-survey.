  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard title="Tổng Đợt Khảo Sát" value={stats.total} icon={ClipboardList} color="text-[#00A99D]" bg="bg-[#00A99D]/10" />
                  ...
                  <tr key={s.id} className="group hover:bg-slate-50/50 transition-colors text-xs font-semibold">
                    ...
                    <td className="pr-6 p-2 border border-slate-200">
                      <div className="flex justify-end gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                        <Tooltip label="Sửa">
                           <button onClick={() => handleOpenEdit(s)} className="p-2 text-slate-400 hover:text-[#00A99D] hover:bg-[#00A99D]/10 rounded-lg"><Edit2 className="w-4 h-4" /></button>
                        </Tooltip>
                        ...
                        <Tooltip label="Kết quả">
                           <Link href={"/admin/surveys/"+s.id+"/results"} className="p-2 text-slate-400 hover:text-[#00A99D] hover:bg-[#00A99D]/10 rounded-lg"><BarChart3 className="w-4 h-4" /></Link>
                        </Tooltip>
                        <Tooltip label="Xóa">
            ...
            return (
              <div key={s.id} className="bg-white rounded-3xl border border-slate-200 p-6 hover:shadow-xl transition-all group relative overflow-hidden">
                ...
                <div className="grid grid-cols-3 gap-2 mt-auto">
                   ...
                   <Link href={"/admin/surveys/"+s.id+"/results"} className="flex items-center justify-center gap-1.5 py-2.5 bg-slate-100 hover:bg-[#00A99D] hover:text-white rounded-xl text-xs font-bold transition-all">
                 ...
                 <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                       ...
                       <div>
                          ...
                          <select value={form.targetAudience} onChange={e => setForm({...form, targetAudience: e.target.value})} className="w-full text-sm font-bold text-[#00A99D] focus:ring-2 focus:ring-indigo-500 outline-none text-xs font-semibold">
