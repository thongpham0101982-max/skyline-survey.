  ...
  return (
    <div className="space-y-8 font-sans text-slate-800 animate-in fade-in duration-500">
      ...
      <div className="relative rounded-[2rem] bg-white border border-slate-100 shadow-[0_20px_50px_rgba(0,59,58,0.05)] overflow-hidden">
        <div className="bg-gradient-to-r from-[#003B3A] via-[#005A5B] to-[#00A99D] p-6 sm:p-8 text-white flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-6 py-3 rounded-2xl bg-[#00A99D] hover:bg-[#009688] text-white font-black text-xs uppercase tracking-wider flex items-center gap-2.5 shadow-lg shadow-[#00A99D]/30 transition-all active:scale-95 disabled:opacity-40"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-3">
              <label className="text-[11px] font-black text-slate-400 uppercase tracking-wider flex items-center gap-2">
                <CalendarDays className="w-3.5 h-3.5 text-[#00A99D]" />
                1. Chọn Niên Khoá
              </label>
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${
                    filterYearId === "ALL" 
                      ...
                      : "bg-white text-slate-600 border border-slate-200 hover:border-[#00A99D] hover:text-[#00A99D]"
                  }`}
                ...
                {years.filter((y: any) => !y.isOff).map((y: any) => (
                  <button
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-bold transition-all ${
                      filterYearId === y.id 
                        ? "bg-[#00A99D] text-white shadow-md shadow-[#00A99D]/20 scale-105" 
                        : "bg-white text-slate-600 border border-slate-200 hover:border-[#00A99D] hover:text-[#00A99D]"
                    }`}
                  >
                    {y.name}
            ...
            <div className="flex-1 max-w-xl space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full h-12 pl-4 pr-10 bg-white border-2 border-slate-200 focus:border-[#00A99D] rounded-2xl font-bold text-slate-800 text-sm outline-none transition-all cursor-pointer shadow-sm"
                >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
          <div className="w-12 h-12 rounded-2xl bg-teal-50 text-[#00A99D] flex items-center justify-center shrink-0">
      ...
      <div className="bg-white rounded-[2rem] border border-slate-100 shadow-[0_20px_50px_rgba(0,0,0,0.03)] overflow-hidden">
        ...
        <div className="p-6 border-b border-slate-100 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input
              ...
              className="w-full h-11 pl-11 pr-4 bg-slate-50 border border-slate-200 focus:border-[#00A99D] rounded-xl text-xs font-semibold text-slate-800 outline-none transition-all"
            />
            {searchTerm && (
              ...
              <tr className="bg-slate-50/80 text-slate-400 font-black uppercase tracking-wider text-[10px] border-b border-slate-100">
                <th className="py-4 px-4 w-12 text-center">
                  <input
                    ...
                    className="w-4 h-4 rounded border-slate-300 text-[#00A99D] focus:ring-[#00A99D] cursor-pointer"
                  />
                </th>
                ...
                <tr>
                  <td colSpan={8} className="py-16 text-center">
                    <div className="max-w-xs mx-auto flex flex-col items-center space-y-4 opacity-50">
                      {loading ? <RefreshCw className="w-10 h-10 animate-spin text-[#00A99D]" /> : <Search className="w-10 h-10 text-slate-400" />}
        ...
        <div className="p-6 bg-slate-50 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 font-medium">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-xl bg-[#00A99D]/10 text-[#00A99D] flex items-center justify-center shrink-0">
      ...
      {linkModalStudent && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-100 space-y-6 animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-2xl bg-teal-50 text-[#00A99D] flex items-center justify-center">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-11 pl-10 pr-4 bg-slate-50 border border-slate-200 focus:border-[#00A99D] rounded-xl text-xs font-semibold outline-none"
                />
                {searching && <RefreshCw className="w-4 h-4 animate-spin text-[#00A99D] absolute right-3 top-1/2 -translate-y-1/2" />}
              </div>
            </div>
                ...
                return (
                  <div key={resSt.id} className="p-3 rounded-xl bg-slate-50 hover:bg-teal-50/60 border border-slate-100 flex items-center justify-between gap-3 transition-all">
                    ...
                    <button
                      ...
                      disabled={linking}
                      className="px-3 py-1.5 rounded-lg bg-[#00A99D] hover:bg-[#009688] text-white font-bold text-[11px] transition-all disabled:opacity-50"
                    >
