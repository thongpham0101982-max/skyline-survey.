  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-4 rounded-2xl border border-slate-200/60 shadow-2xs no-print">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 flex-1">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 focus:border-[#00A99D] focus:bg-white focus:ring-2 focus:ring-[#00A99D]/10 rounded-xl text-xs outline-none transition-all font-semibold text-slate-700"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 border rounded-xl text-xs font-bold transition-all shrink-0 cursor-pointer ${
                activeFiltersCount > 0 || showFilters
                  ? "bg-[#00A99D]/5 border-[#00A99D]/30 text-[#00A99D] shadow-2xs"
            ...
            >
              ...
              {activeFiltersCount > 0 && (
                <span className="w-5 h-5 bg-[#00A99D] text-white rounded-full flex items-center justify-center text-[10px] font-black font-sans">
                  {activeFiltersCount}
                </span>
              )}
              {showFilters ? (
        ...
        <button
          onClick={openCreate}
          className="flex items-center justify-center gap-2 bg-[#00A99D] hover:bg-[#009085] text-white px-5 py-2.5 rounded-xl font-bold shadow-md shadow-[#00A99D]/15 transition-all text-xs cursor-pointer"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-1.5 text-xs font-semibold">
              ...
              <select
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs outline-none text-slate-700 focus:border-[#00A99D] focus:bg-white transition-all font-semibold"
              >
      ...
      {filteredExams.length > 0 ? (
                ...
                <div
                  ...
                  className={`bg-white rounded-2xl border transition-all duration-300 hover:-translate-y-1 hover:shadow-lg flex flex-col justify-between overflow-hidden relative group ${
                    exam.isPriority
                      ...
                      : "border-slate-200/70 hover:border-[#00A99D]/40 shadow-2xs"
                  }`}
                >
                  ...
                  <div className="p-5 space-y-4">
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1 flex-1 min-w-0">
                        ...
                        <h4 className="font-black text-slate-800 text-sm leading-snug group-hover:text-[#00A99D] transition-colors line-clamp-2" title={exam.name}>
                          {exam.name}
                        </h4>
                      </div>
                    ...
                    <div className="space-y-2 pt-1 font-bold text-xs text-slate-600">
                      <div className="flex items-center gap-2 text-[11px] font-semibold">
                        <Tag className="w-3.5 h-3.5 text-[#00A99D]/80 shrink-0" />
                      ...
                      {exam.round && (
                        <div className="flex items-center gap-2 text-[11px] font-semibold">
                          <Layers className="w-3.5 h-3.5 text-[#00A99D]/80 shrink-0" />
                      ...
                      <div className="flex items-center gap-2 text-[11px] font-semibold">
                        <User className="w-3.5 h-3.5 text-[#00A99D]/80 shrink-0" />
                        ...
                        {status.label === "Đang diễn ra" && progress !== null && (
                          <div className="space-y-1 font-bold">
                            <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
                              <div
                                className="bg-gradient-to-r from-teal-400 to-[#00A99D] h-full transition-all duration-500"
                    ...
                    <div className="flex items-center gap-2 pt-2 border-t border-slate-200/40">
                      <div className="flex items-center gap-1.5 flex-1">
                        <Link
                          ...
                          className="flex-1 text-center bg-white hover:bg-teal-50/40 text-[#00A99D] border border-slate-200 hover:border-teal-200 py-1.5 rounded-lg text-[10px] font-black transition-all flex items-center justify-center gap-1 cursor-pointer"
                        >
                        ...
                        <Link
                          ...
                          className="flex-1 text-center bg-[#00A99D] hover:bg-[#009085] text-white py-1.5 rounded-lg text-[10px] font-black transition-all flex items-center justify-center gap-1 shadow-xs cursor-pointer"
                        >
                      ...
                      >
                        ...
                        <td className="py-4 px-4">
                          <div className="space-y-0.5 text-xs font-semibold">
                            ...
                            <div className="text-[10px] text-[#00A99D] font-bold bg-[#00A99D]/5 w-max px-1.5 py-0.5 rounded-sm">
                        ...
                        <td className="py-4 px-5 text-right">
                          <div className="flex items-center justify-end gap-2">
                            <Link
                              href={`/admin/ktdbcl/students?examId=${exam.id}`}
                              className="bg-white hover:bg-teal-50/40 text-[#00A99D] border border-slate-200 hover:border-teal-200 px-2.5 py-1 rounded-lg text-[10px] font-black transition-all inline-flex items-center gap-1 cursor-pointer"
                            >
                              Đăng ký
                            </Link>
                            <Link
                              href={`/admin/ktdbcl/results?examId=${exam.id}`}
                              className="bg-[#00A99D] hover:bg-[#009085] text-white px-2.5 py-1 rounded-lg text-[10px] font-black transition-all inline-flex items-center gap-1 shadow-xs cursor-pointer"
                            >
                              Nhập điểm
                            </Link>
        ...
        <div className="bg-white border border-slate-200/60 rounded-2xl flex flex-col items-center justify-center py-20 text-slate-400 shadow-2xs">
          <Calendar className="w-16 h-16 mb-4 opacity-20 text-[#00A99D]" />
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-2xl max-w-2xl w-full overflow-hidden flex flex-col max-h-[90vh] animate-scale-up">
            ...
            <div className="p-6 overflow-y-auto space-y-5 text-xs font-semibold">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full border border-slate-200 rounded-xl px-3 py-2.5 focus:border-[#00A99D] focus:ring-2 focus:ring-[#00A99D]/10 outline-none transition-all text-slate-700 bg-slate-50/50 font-semibold"
                  >
                ...
                {form.plan === "KHAC" && (
                  <div className="md:col-span-2 space-y-1.5 animate-fade-in">
                    ...
                    <input
                      ...
                      className="w-full border border-slate-200 rounded-xl px-4 py-2.5 focus:border-[#00A99D] focus:ring-2 focus:ring-[#00A99D]/10 outline-none transition-all text-slate-700 bg-slate-50/50 font-semibold"
                    />
                  </div>
                )}
              ...
              <div className="flex items-center gap-3 bg-slate-50 p-3 rounded-xl border border-slate-200/50">
                <input
                  ...
                  className="w-4.5 h-4.5 text-[#00A99D] focus:ring-[#00A99D]/20 border-slate-300 rounded-sm cursor-pointer"
                />
            ...
            <div className="bg-slate-50 border-t border-slate-100 px-6 py-4 flex items-center justify-end gap-3 shrink-0">
              ...
              <button
                onClick={handleSave}
                disabled={saving}
                className="px-6 py-2.5 bg-gradient-to-r from-[#00A99D] to-[#009085] hover:opacity-95 text-white rounded-xl font-bold text-xs shadow-md shadow-[#00A99D]/15 transition-all disabled:opacity-60 flex items-center gap-1.5 cursor-pointer"
              >
                {saving ? (
                  <>
                    {/* Spinner icon SVG */}
