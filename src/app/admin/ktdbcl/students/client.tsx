  ...
  return (
    <div className="space-y-6 text-xs font-semibold">
      ...
      <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-xs space-y-4 animate-fade-in">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2">
            <Layers className="w-4 h-4 text-[#48BFE3]" />
            <h3 className="text-sm font-bold text-slate-800">Bộ Lọc Đăng Ký &amp; Theo Dõi</h3>
          </div>
          {activeExamObj && activeExamObj.grade && (
            <span className="bg-[#E6F6F5] border border-[#48BFE3]/15 rounded-lg px-2.5 py-1 text-[10px] text-[#009085] font-bold flex items-center gap-1.5 w-fit">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {showAllRegistered ? (
            <>
              ...
              <div className="bg-[#E6F6F5]/50 border border-[#48BFE3]/15 rounded-2xl p-4 shadow-xs flex items-center gap-3 animate-fade-in">
                <div className="w-9 h-9 rounded-xl bg-white text-[#48BFE3] flex items-center justify-center border border-[#48BFE3]/20 shadow-xs">
      ...
      {selectedIds.length > 0 && (
        <div className="bg-[#E6F6F5] border border-[#48BFE3]/20 px-5 py-3 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 animate-fade-in no-print shadow-xs">
          <div className="flex items-center gap-2 text-[#009085]">
            <Check className="w-4.5 h-4.5 text-[#48BFE3]" />
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            {!showAllRegistered && (
              <button
                ...
                disabled={updating}
                className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 bg-[#48BFE3] hover:bg-[#009085] text-white px-5 py-2 rounded-xl font-bold transition-all shadow-sm shadow-[#48BFE3]/15 disabled:opacity-50"
              >
      ...
      <div className="bg-white rounded-2xl border border-slate-200/85 overflow-hidden shadow-xs animate-fade-in">
        ...
        <div className="bg-slate-50/70 border-b border-slate-100 px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Users className="w-4.5 h-4.5 text-[#48BFE3]" />
          ...
          {(showAllRegistered || selectedClass) && students.length > 0 && (
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-1.5 text-[11px] font-semibold border border-slate-200 rounded-lg outline-none focus:border-[#48BFE3] transition-all bg-white"
              />
              </div>
            </div>
          )}
        ...
        {!showAllRegistered && !selectedClass ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 text-slate-400">
            <Loader2 className="w-8 h-8 animate-spin text-[#48BFE3] mb-3" />
                ...
                <tr className="bg-slate-50/50 border-b border-slate-100 text-[10px] text-slate-500 font-bold uppercase tracking-wider">
                  <th className="px-6 py-3 w-12 text-center">
                    <input
                      ...
                      className="w-3.5 h-3.5 rounded text-[#48BFE3] focus:ring-[#48BFE3] cursor-pointer"
                    />
                  </th>
                  ...
                  return (
                    <tr
                      ...
                      className={`hover:bg-slate-50/40 transition-colors cursor-pointer ${
                        isChecked ? "bg-[#48BFE3]/5 hover:bg-[#48BFE3]/5" : ""
                      }`}
                    >
                      ...
                      <td className="px-6 py-3.5 font-bold text-slate-800 text-xs sm:text-sm">
                        <div className="flex items-center gap-2">
                          <div className={`w-6.5 h-6.5 rounded-lg flex items-center justify-center font-bold text-[9px] uppercase ${
                            isChecked ? "bg-[#48BFE3] text-white" : "bg-slate-100 text-slate-500"
                          }`}>
