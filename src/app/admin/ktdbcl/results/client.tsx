...
function AchievementCardItem({ ach, categoryLabels, levelLabels }: { ach: any; categoryLabels: Record<string, string>; levelLabels: Record<string, string> }) {
  const catName = categoryLabels[ach.category] || ach.category || "Lĩnh vực khác";
  const levelName = levelLabels[ach.level] || ach.level || "";
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex-1 flex flex-col sm:flex-row sm:items-center gap-4 min-w-0">
                <div className="w-full sm:w-80 flex flex-col gap-1.5 flex-shrink-0">
                  ...
                  {filteredExams.length === 0 ? (
                    ...
                    <select
                      ...
                      className="w-full border border-slate-200 rounded-lg px-3 py-2.5 text-xs focus:border-[#48BFE3] outline-none font-black text-slate-700 bg-slate-50/50"
                    >
                      {filteredExams.map(e => (
                ...
                {selectedExamId && (
                  <div className="flex flex-wrap gap-2 items-center pt-2 sm:pt-4">
                    <span className="text-[10px] font-bold bg-[#48BFE3]/10 text-[#48BFE3] px-2.5 py-1 rounded-md border border-[#48BFE3]/20">
              ...
              <div className="flex items-center gap-3 self-end sm:self-center">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 bg-[#48BFE3] hover:bg-[#009085] disabled:opacity-50 text-white px-5 py-2.5 rounded-xl font-bold shadow-md shadow-[#48BFE3]/15 transition-all text-xs"
                >
                ...
                <div>
                  <h3 className="font-extrabold text-slate-800 text-base flex items-center gap-2">
                    ...
                    <select 
                      ...
                      className="border border-slate-200 rounded-lg px-2 py-1 text-xs focus:border-[#48BFE3] outline-none font-semibold text-slate-700"
                    >
                  ...
                  {checkedRowIds.size > 0 && (
                    <div className="bg-slate-900/95 text-white border border-slate-800 rounded-2xl shadow-xl px-6 py-4 flex flex-col md:flex-row items-center justify-between gap-4 z-50 fixed bottom-6 left-1/2 -translate-x-1/2 max-w-4xl w-[90%] backdrop-blur-md transition-all duration-300 ease-out transform scale-100 animate-in fade-in slide-in-from-bottom-4">
                      <div className="flex items-center gap-3">
                        <span className="bg-[#48BFE3]/15 border border-[#48BFE3]/20 text-[#00E5D5] px-3 py-1 rounded-lg text-xs font-black flex items-center gap-1.5">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        <select
                          ...
                          className="border border-slate-700 rounded-lg px-2.5 py-1.5 text-xs outline-none bg-slate-800 focus:border-[#48BFE3] font-bold text-white transition-all cursor-pointer"
                        >
                        ...
                        <button 
                          ...
                          className="px-5 py-1.5 bg-[#48BFE3] hover:bg-[#009085] text-white rounded-lg text-xs font-black transition-all shadow-md shadow-[#48BFE3]/20 cursor-pointer"
                        >
                          Áp dụng hàng loạt
                        </button>
                      </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-xs space-y-4 no-print animate-fade-in">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h3 className="text-slate-800 font-bold text-sm flex items-center gap-2">
                <div className="w-7 h-7 bg-[#48BFE3]/10 rounded-lg flex items-center justify-center">
                  <Search className="w-4 h-4 text-[#48BFE3]" />
                </div>
                Bộ lọc Báo cáo thành tích
              </h3>
              <span className="text-[10px] font-black bg-[#48BFE3]/10 text-[#48BFE3] px-3 py-1.5 rounded-lg border border-[#48BFE3]/20 flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
              <div>
                ...
                <select
                  ...
                  className="w-full border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs focus:border-[#48BFE3] outline-none font-semibold text-slate-700 bg-slate-50/50"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full border border-slate-200 rounded-lg px-2.5 py-1.5 text-xs focus:border-[#48BFE3] outline-none font-semibold text-slate-700 bg-slate-50/50 disabled:opacity-50"
                >
                  <option value="">-- Tất cả --</option>
                  {classes
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 no-print animate-fade-in">
            ...
            <div className="bg-gradient-to-br from-teal-50/90 via-cyan-50/40 to-teal-100/60 p-5 rounded-2xl border border-teal-200/80 shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 group">
              <div className="flex items-center justify-between mb-3">
                <div className="p-3 bg-[#48BFE3] text-white rounded-xl shadow-md shadow-teal-500/20 group-hover:scale-110 transition-transform">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-xs overflow-hidden print-area animate-fade-in">
            ...
            <div className="bg-gradient-to-r from-slate-50 to-white border-b border-slate-100 px-6 py-4 flex items-center justify-between no-print">
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 bg-[#48BFE3]/10 rounded-xl flex items-center justify-center">
                  <FileSpreadsheet className="w-4.5 h-4.5 text-[#48BFE3]" />
                </div>
                <div>
                  ...
                  <tbody className="divide-y divide-slate-100 text-xs font-semibold text-slate-700">
                    {reportData.map((row, idx) => (
                      <tr key={`${row.achievementId}-${row.studentId}`} className="hover:bg-slate-50/50 transition-all">
                        ...
                        <td className="py-3 px-6 text-[#48BFE3] font-bold">{row.achievementName}</td>
                        <td className="py-3 px-6">
              ...
              {Object.entries(groupedData).map(([groupName, achList]: [string, any[]]) => (
                <div key={groupName} className="border border-slate-200/80 rounded-2xl overflow-hidden bg-white shadow-xs animate-fade-in hover:shadow-md transition-all duration-300">
                  ...
                  <div className="bg-gradient-to-r from-slate-50 via-teal-50/20 to-slate-50 border-b border-slate-200/80 px-5 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-[#48BFE3]/10 text-[#48BFE3] rounded-xl flex items-center justify-center border border-[#48BFE3]/20 shadow-2xs">
                        {viewGroup === 'exam' ? (
                    ...
                    <span className="text-[11px] font-black bg-[#48BFE3]/10 text-[#48BFE3] px-3 py-1 rounded-full border border-[#48BFE3]/20 uppercase">
                  ...
                  <div className="p-5 bg-slate-50/30 grid grid-cols-1 md:grid-cols-2 gap-4">
                    {achList.map((ach) => <AchievementCardItem key={ach.id} ach={ach} categoryLabels={CATEGORY_LABELS} levelLabels={LEVEL_LABELS} />)}
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="space-y-6 max-w-6xl mx-auto no-print animate-fade-in">
              ...
              <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-xs font-black text-slate-700 uppercase tracking-wider">
                    <span className="w-5 h-5 rounded-full bg-teal-50 text-[#48BFE3] border border-teal-200/80 flex items-center justify-center text-[10px] font-black">1</span>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full border border-slate-200 rounded-xl pl-10 pr-9 py-3 text-xs focus:ring-2 focus:ring-[#48BFE3]/20 focus:border-[#48BFE3] outline-none font-semibold text-slate-700 bg-slate-50/50 shadow-2xs transition-all"
                    />
                  ...
                  {searchResults.length > 0 && (
                    <div className="border border-slate-200/80 rounded-xl bg-white shadow-xl overflow-hidden divide-y divide-slate-100 max-h-64 overflow-y-auto">
                      {searchResults.map(student => (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-[#48BFE3] to-[#008A81] text-white flex items-center justify-center font-black text-xs uppercase shadow-2xs">
                              {student.studentName.split(" ").pop()?.charAt(0) || "H"}
                            </div>
                            <div>
                              <div className="font-black text-slate-800 group-hover:text-[#48BFE3] transition-colors">{student.studentName}</div>
                  ...
                  {loadingSearch && (
                    <p className="text-xs text-[#48BFE3] animate-pulse font-bold">Đang tìm kiếm dữ liệu học sinh...</p>
                  )}
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full border border-slate-200 rounded-xl px-3 py-2 text-xs focus:ring-2 focus:ring-[#48BFE3]/20 focus:border-[#48BFE3] outline-none font-semibold text-slate-700 bg-slate-50/50 shadow-2xs"
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full border border-slate-200 rounded-xl px-3 py-2 text-xs focus:ring-2 focus:ring-[#48BFE3]/20 focus:border-[#48BFE3] outline-none font-semibold text-slate-700 bg-slate-50/50 disabled:opacity-50 shadow-2xs"
                      >
                  ...
                  {profileClassId && (
                    <div className="pt-3 border-t border-slate-100 animate-fade-in space-y-2">
                      <div className="flex items-center justify-between text-[10px] font-extrabold text-slate-500 uppercase tracking-wider">
                        ...
                        <span className="text-[#48BFE3]">Nhấp chọn để tra cứu</span>
                      </div>
                      {loadingClassStudents ? (
                        <p className="text-xs text-[#48BFE3] animate-pulse py-2 font-bold">Đang tải danh sách học sinh...</p>
                            ...
                            <button
                              ...
                              className={`w-full text-left p-2.5 rounded-xl border transition-all flex items-center justify-between text-xs cursor-pointer ${
                                selectedStudentProfile?.id === student.id 
                                  ? 'bg-teal-50/80 border-[#48BFE3] text-[#48BFE3] shadow-xs' 
                            ...
                            >
                              <div className="flex items-center gap-2.5 truncate">
                                <div className={`w-7 h-7 rounded-lg flex items-center justify-center font-black text-[10px] uppercase flex-shrink-0 ${
                                  selectedStudentProfile?.id === student.id ? 'bg-[#48BFE3] text-white' : 'bg-slate-200 text-slate-700'
                                }`}>
                                  {student.studentName.split(" ").pop()?.charAt(0) || "H"}
                                </div>
            ...
            {loadingProfile ? (
              <div className="py-20 text-center text-slate-400 bg-white border border-slate-200/80 rounded-2xl shadow-xs">
                <div className="animate-spin rounded-full h-9 w-9 border-3 border-[#48BFE3] border-t-transparent mx-auto mb-3"></div>
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div className="bg-gradient-to-br from-teal-50/80 via-white to-slate-50 border border-teal-200/80 rounded-2xl p-6 shadow-xs hover:shadow-md transition-all duration-300 flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
                  ...
                  <div className="absolute top-0 right-0 w-64 h-64 bg-[#48BFE3]/5 rounded-full blur-3xl pointer-events-none" />
                  
                  <div className="flex items-start gap-5 relative z-10">
                    <div className="w-16 h-16 bg-gradient-to-br from-[#48BFE3] to-[#007B73] rounded-2xl flex items-center justify-center text-white flex-shrink-0 shadow-lg shadow-[#48BFE3]/20 border border-white/20 font-black text-2xl uppercase">
                  ...
                  <div className="self-start md:self-center bg-white p-4 rounded-xl border border-slate-200/80 shadow-2xs text-right min-w-[180px] relative z-10">
                    ...
                    <div className="text-2xl font-black text-[#48BFE3]">{selectedStudentProfile.className}</div>
                ...
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-200/80 pb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-xs font-black bg-[#48BFE3] text-white px-3 py-1 rounded-full shadow-2xs ml-1">
              ...
              <div className="bg-gradient-to-br from-slate-50 via-teal-50/20 to-indigo-50/20 border border-slate-200/80 rounded-2xl p-16 text-center text-slate-400 shadow-xs animate-fade-in">
                <div className="w-20 h-20 bg-[#48BFE3]/10 rounded-3xl flex items-center justify-center mx-auto mb-4 border border-[#48BFE3]/20 shadow-2xs">
                  <BookOpen className="w-10 h-10 text-[#48BFE3]" />
                </div>
