  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200/80 p-6 rounded-2xl shadow-sm">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div>
            <select 
              ...
              className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs font-bold text-slate-700 outline-none focus:border-[#48BFE3]"
            >
        ...
        {/* Upload Zone */}
        <div className="mt-6 border-2 border-dashed border-slate-200 rounded-2xl p-8 text-center hover:border-[#48BFE3]/60 transition-colors bg-slate-50/50">
        ...
        <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm space-y-6 animate-in zoom-in-95 duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <select 
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs font-semibold text-slate-700 outline-none border-[#48BFE3]/40"
              >
          ...
          <div className="border border-slate-100 rounded-2xl overflow-hidden mt-6">
            <div className="bg-slate-50 px-4 py-3 border-b border-slate-100 flex justify-between items-center text-xs font-bold text-slate-700">
              ...
              <span className="text-[#48BFE3]">Chỉ hàng Hợp lệ mới được lưu</span>
            </div>
          ...
          <div className="flex justify-end pt-4 border-t border-slate-100">
            <button
              ...
              onClick={runImport}
              disabled={importing}
              className="bg-[#48BFE3] hover:bg-[#008d83] text-white text-xs font-bold py-2.5 px-8 rounded-xl flex items-center justify-center gap-2 shadow-md disabled:bg-slate-300"
            >
      ...
      <div className="bg-white border border-slate-200/80 p-6 rounded-2xl shadow-sm space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-100 pb-4 gap-4">
          ...
          <div className="relative w-full sm:w-60">
            ...
            <input 
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-9 pr-4 py-1.5 text-xs text-slate-700 outline-none focus:border-[#48BFE3]"
            />
          </div>
        </div>
        ...
        {loadingExisting ? (
          <div className="text-center py-12">
            <RefreshCw className="w-6 h-6 text-[#48BFE3] animate-spin mx-auto mb-2" />
