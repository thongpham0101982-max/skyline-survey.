...
export function MoveToBatchModal({
  selectedIds,
  onClose,
  onSuccess,
  periods
    ...
    <div className="fixed inset-0 z-[200] bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between bg-slate-50/50">
          <h3 className="font-bold text-slate-800 text-lg">Chuyển đợt khảo sát</h3>
        ...
        <div className="p-6 space-y-5">
          <div className="bg-[#48BFE3]/10 text-[#48BFE3] px-4 py-3 rounded-xl text-sm font-medium flex items-center gap-2">
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full h-11 px-4 bg-white border border-slate-200 rounded-xl text-sm text-slate-700 font-medium focus:outline-none focus:ring-2 focus:ring-[#48BFE3]/20 focus:border-[#48BFE3] transition-all"
              >
        ...
        <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-end gap-3 bg-slate-50">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-[#48BFE3] hover:bg-[#009085] disabled:opacity-50 text-white font-bold rounded-xl shadow-sm hover:shadow transition-all text-sm flex items-center gap-2"
          >
