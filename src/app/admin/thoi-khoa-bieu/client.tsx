    ...
    <div className="min-h-screen bg-slate-100/70 p-4 sm:p-6 space-y-6">
      ...
      <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-[#003B3A] to-[#48BFE3] text-white flex items-center justify-center font-black shadow-md">
        ...
        <div className="lg:col-span-3 bg-white rounded-3xl shadow-sm border border-slate-200 p-4 space-y-4 sticky top-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-xs font-bold rounded-xl border border-slate-200 outline-none focus:ring-2 focus:ring-[#48BFE3]"
            />
          </div>

          <div className="text-[10px] font-bold text-slate-400 flex items-center gap-1">
            <Info className="w-3.5 h-3.5 shrink-0 text-[#48BFE3]" />
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 space-y-6">
          ...
          <div className="bg-slate-50 p-5 rounded-2xl border border-slate-200 grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
            ...
            <div className="md:col-span-5 space-y-1.5">
              ...
              <select
                ...
                className="w-full bg-white border border-slate-300 rounded-xl px-3.5 py-2.5 text-xs font-bold text-slate-800 outline-none focus:border-[#48BFE3] focus:ring-2 focus:ring-[#48BFE3]/20 transition-all"
              >
          ...
          {selectedClassObj ? (
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-[#003B3A] to-[#48BFE3] text-white p-5 rounded-2xl shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {classScheduleStats.slotsList.map((item: any, i: number) => (
                      <div key={i} className="bg-white p-3.5 rounded-xl border border-slate-200 shadow-2xs flex items-center justify-between">
                        <div>
                          <span className="text-[10px] font-black uppercase px-2 py-0.5 rounded bg-teal-50 text-[#48BFE3] mr-2">
            ...
            <div className="md:col-span-7 space-y-1.5">
              ...
              <div className="flex gap-2">
                <select
                  ...
                  className="flex-1 bg-white border border-slate-300 rounded-xl px-3.5 py-2.5 text-xs font-bold text-slate-800 outline-none focus:border-[#48BFE3] focus:ring-2 focus:ring-[#48BFE3]/20 transition-all"
                >
                ...
                <input
                  ...
                  className="w-48 bg-white border border-slate-300 rounded-xl px-3.5 py-2.5 text-xs font-bold text-slate-800 outline-none focus:border-[#48BFE3] transition-all"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-6 shadow-2xl space-y-4 border border-slate-100 animate-in fade-in zoom-in duration-200">
            <div className="flex items-center justify-between border-b border-slate-150 pb-3">
              <div className="flex items-center gap-2">
                <Edit3 className="w-5 h-5 text-[#48BFE3]" />
            ...
            <div className="bg-slate-50 p-3 rounded-2xl border border-slate-150 text-xs font-bold text-slate-700 flex flex-wrap gap-x-4 gap-y-1">
              <span>Lớp: <span className="text-[#48BFE3] font-black">{editingCell.className}</span></span>
            ...
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full text-xs font-bold p-3 rounded-xl border border-slate-200 outline-none focus:ring-2 focus:ring-[#48BFE3]"
              >
