...
function Spin() {
  return <div className="flex items-center justify-center py-16"><div className="relative"><div className="w-12 h-12 rounded-full border-4 border-slate-300 border-t-teal-600 animate-spin"></div><Baby className="w-5 h-5 text-[#00A19A] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" /></div></div>;
}

function Empty({ text, sub }: { text: string; sub?: string }) {
  return <div className="flex flex-col items-center justify-center py-16 text-center"><div className="w-20 h-20 bg-[#00A19A]/5 rounded-full flex items-center justify-center mb-4"><Baby className="w-10 h-10 text-teal-400" /></div><p className="font-black text-slate-500 text-sm">{text}</p>{sub && <p className="text-xs text-slate-400 mt-1 font-medium">{sub}</p>}</div>;
}

function TypeBadge({ t }: { t: string }) {
  const map: Record<string, string> = {
    KHAO_SAT_LE: "bg-blue-50 text-blue-700 border border-blue-200",
    OPEN_DAY: "bg-[#00A19A]/5 text-purple-700 border border-purple-200"
  };
...
Trân trọng kính mời Quý phụ huynh và các em học sinh!`;
  ...
  return (
    <div className="space-y-3 font-sans max-w-[1440px] mx-auto pb-16">
                ...
                <div key={p.id} className="bg-white rounded-none border border-slate-300 shadow-none overflow-hidden hover:border-slate-300 transition-all">
                  <div className="px-4 py-3.5 flex flex-wrap items-center justify-between gap-3 cursor-pointer" onClick={() => setExpandedId(expandedId === p.id ? null : p.id)}>
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-none bg-[#00A19A]/5 flex items-center justify-center flex-shrink-0"><Baby className="w-6 h-6 text-teal-400" /></div>
                      <div>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button onClick={e => { e.stopPropagation(); openEditPeriod(p); }} className="p-2 text-slate-400 hover:text-[#00A19A] hover:bg-[#00A19A]/5 rounded-none transition-all"><Edit2 className="w-4 h-4" /></button>
                  ...
                  {expandedId === p.id && (
                    <div className="border-t border-slate-300 p-5 bg-[#00A19A]/5/30">
                          ...
                          <table className="w-full text-left border-collapse">
                            ...
                            <tbody>
                              {p.batches.map(b => {
                                ...
                                return (
                                  <tr key={b.id} className="hover:bg-[#00A19A]/5/30 transition-colors">
                                    <td className="p-2 border border-slate-200"><span className="inline-flex items-center justify-center w-8 h-8 rounded-none bg-[#00A19A]/5 font-black text-[#00A19A] text-xs">#{b.batchNumber}</span></td>
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-black text-slate-600 uppercase tracking-widest flex items-center gap-2">
              <UserCheck className="w-4 h-4 text-[#00A19A]" /> Phân công Giáo viên Khảo sát
            </h2>
            <div className="flex gap-2">
              <button 
                onClick={fetchAssignments} 
                className="p-2 text-slate-400 hover:text-[#00A19A] hover:bg-[#00A19A]/5 rounded-none transition-all"
              >
            ...
            <div className="lg:col-span-5 space-y-4">
              <div className="bg-white rounded-3xl border border-slate-300 shadow-none p-5 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  {aActiveBatch && (() => {
                    ...
                    return (
                      <div className="bg-gradient-to-br from-[#00A19A]/5 via-white to-teal-50/10 border-l-4 border-l-[#00A19A] border-y border-r border-slate-300 rounded-none p-4 space-y-3.5 shadow-none animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              <div className="bg-white rounded-3xl border border-slate-300 shadow-none p-5 space-y-4">
                <div className="flex items-center justify-between pb-2 border-b border-slate-300">
                  ...
                  <span className="text-[10px] bg-[#00A19A]/5 text-[#00A19A] px-2 py-0.5 rounded-none font-black">
                  ...
                  {teachers
                    ...
                    .map(t => {
                      ...
                      return (
                        <label 
                          key={t.id} 
                          className={`flex items-center justify-between p-3 rounded-none cursor-pointer border transition-all ${isChecked ? "bg-[#00A19A]/5/50 border-slate-300" : "bg-white border-slate-300 hover:border-slate-300 hover:bg-slate-50/30"}`}
                        >
                          <div className="flex items-center gap-3">
                            <input 
                              type="checkbox" 
                              ...
                              className="w-4.5 h-4.5 rounded-none border-slate-300 text-[#00A19A] focus:ring-teal-500 focus:ring-offset-0 cursor-pointer"
                            />
                            <div>
                              <div className="text-sm font-bold text-slate-800 flex items-center gap-2">
                                <span>{t.teacherName}</span>
                                {t.departmentRel?.name && (
                                  <span className="text-[9px] font-black uppercase bg-[#00A19A]/5 text-[#00A19A] border border-slate-300 px-1.5 py-0.5 rounded-none tracking-wider">
                                    {t.departmentRel.name}
                                  </span>
                                )}
                              </div>
                          ...
                          {isChecked && <CheckCircle className="w-4.5 h-4.5 text-[#00A19A] animate-in zoom-in-50 duration-200" />}
                        </label>
                      );
                    })}
                </div>
                ...
                <button 
                  ...
                  className="w-full py-3.5 bg-[#00A19A] text-white font-black rounded-none hover:bg-[#00A19A]-700 disabled:opacity-50 transition-all shadow-none shadow-teal-100/50 flex items-center justify-center gap-2 mt-4 hover:scale-[1.01] active:scale-[0.99] duration-150"
                >
                  {aSaving ? (
                  ...
                  <div className="space-y-3">
                    {assignments.map((assign) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 text-[#00A19A] flex items-center justify-center font-black text-sm text-xs font-semibold">
                            ...
                            <div>
                              ...
                              <div className="flex gap-1.5 mt-1 items-center">
                                <span className="text-[9px] font-black uppercase bg-[#00A19A]/5 text-[#00A19A] border border-slate-300 px-2 py-0.5 rounded-none tracking-wider">
                                  {assign.grade}
                                </span>
                                {assign.batch && (
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={() => openAddCfg("criteria")} className="flex items-center gap-2 px-5 py-2.5 bg-[#00A19A] text-white text-[13px] font-black rounded-none hover:bg-[#00A19A]-700 transition-all shadow-none shadow-teal-100"><Plus className="w-4 h-4" /> Thêm mục</button>
            </div>
          </div>
          {cfgLoading ? <Spin /> : (
                ...
                <div className="overflow-x-auto custom-scrollbar flex-1">
                  <table className="w-full text-left border-collapse">
                    <thead className="bg-[#00A19A]/5 border-b border-slate-300">
                      <tr>
                        <th className="p-2 w-12 border border-slate-200">
                          <input type="checkbox" className="w-4 h-4 rounded accent-[#00A19A]" checked={configs.length > 0 && cfgSelected.length === configs.length} onChange={e => setCfgSelected(e.target.checked ? configs.map(c => c.id) : [])} />
                        </th>
                    ...
                    <tbody className="divide-y divide-teal-50">
                      {configs.map((c, i) => (
                        <tr key={c.id} className="hover:bg-[#00A19A]/5/30 transition-colors">
                          <td className="p-2 w-12 border border-slate-200">
                            <input type="checkbox" className="w-4 h-4 rounded accent-[#00A19A]" checked={cfgSelected.includes(c.id)} onChange={e => setCfgSelected(e.target.checked ? [...cfgSelected, c.id] : cfgSelected.filter(id => id !== c.id))} />
                          </td>
                          <td className="p-2 text-slate-400 text-sm border border-slate-200">{i+1}</td>
                          <td className="p-2 border border-slate-200"><span className="text-[10px] font-black text-[#00A19A] bg-[#00A19A]/5 px-2 py-0.5 rounded-none border border-[#00A19A]/20 uppercase">{c.categoryType}</span></td>
                          <td className="p-2 font-mono text-xs font-bold text-[#00A19A] border border-slate-200">{c.code}</td>
                          <td className="p-2 font-semibold text-slate-700 text-sm border border-slate-200">{c.name}</td>
                          <td className="p-2 text-right border border-slate-200"><div className="flex justify-end gap-1"><button onClick={() => openEditCfg(c)} className="p-2 text-slate-300 hover:text-[#00A19A] hover:bg-[#00A19A]/5 rounded-none"><Edit2 className="w-4 h-4" /></button><button onClick={() => setConfirm({ msg: `Xóa "${c.name}"?`, fn: () => doDeleteCfg(c.id) })} className="p-2 text-slate-300 hover:text-rose-500 hover:bg-rose-50 text-xs font-semibold"><Trash2 className="w-4 h-4" /></button></div></td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
      ...
      {tab === "children" && (
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <div className="bg-white rounded-none border border-slate-300 shadow-none p-4 flex flex-wrap items-center gap-4">
            ...
            <button onClick={fetchChildren} className="flex items-center gap-1.5 text-sm font-bold text-[#00A19A] hover:bg-teal-100 text-xs font-semibold"><Search className="w-4 h-4" /> Tìm</button>
            ...
            {cLoading ? <Spin /> : filtChildren.length === 0 ? (
              ...
              <div className="overflow-x-auto custom-scrollbar flex-1">
                <table className="w-full text-left text-sm whitespace-nowrap border-collapse">
                  <thead className="bg-[#00A19A]/5 border-b border-slate-300">
                    <tr>
                      <th className="p-2 w-12 border border-slate-200"><input type="checkbox" className="w-4 h-4 rounded accent-[#00A19A]" checked={filtChildren.length > 0 && cSelected.length === filtChildren.length} onChange={e => setCSelected(e.target.checked ? filtChildren.map(c => c.id) : [])} /></th>
                      {["STT", "Mã bé", "Họ và tên", "Ngày sinh", "Giới tính", "Nhóm tuổi", "Cơ sở", "Kết quả", "Thao tác"].map(h => <th key={h} className="p-2 text-[10px] font-black text-slate-400 uppercase tracking-widest border border-slate-200">{h}</th>)}
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-teal-50">
                    {filtChildren.map((child, i) => (
                      <tr key={child.id} className={`hover:bg-[#00A19A]/5/30 transition-colors ${cSelected.includes(child.id) ? "bg-[#00A19A]/5/50" : ""}`}>
                        <td className="p-2 border border-slate-200"><input type="checkbox" className="w-4 h-4 rounded accent-[#00A19A]" checked={cSelected.includes(child.id)} onChange={e => setCSelected(e.target.checked ? [...cSelected, child.id] : cSelected.filter(id => id !== child.id))} /></td>
                        <td className="p-2 text-slate-400 text-sm border border-slate-200">{i+1}</td>
                        <td className="p-2 border border-slate-200"><span className="font-mono text-xs font-black text-[#00A19A] bg-[#00A19A]/5 px-2 py-1 rounded-none">{child.studentCode}</span></td>
                        <td className="p-2 border border-slate-200"><div className="flex items-center gap-2.5"><div className="w-8 h-8 rounded-full bg-gradient-to-br from-teal-500 to-fuchsia-400 flex items-center justify-center text-white font-black text-xs shadow-none">{child.fullName?.charAt(0)}</div><span className="font-bold text-slate-800 text-sm">{child.fullName}</span></div></td>
                        <td className="p-2 text-sm text-slate-500 border border-slate-200">{child.dateOfBirth ? new Date(child.dateOfBirth).toLocaleDateString("vi-VN") : "—"}</td>
                        <td className="p-2 border border-slate-200">{child.gender ? <span className={`text-[10px] font-bold px-2 py-0.5 rounded-none border ${child.gender === "Nữ" || child.gender === "F" ? "bg-teal-50 text-[#00A19A] border-teal-200" : "bg-blue-50 text-blue-700 border-blue-200"}`}>{child.gender === "M" ? "Nam" : child.gender === "F" ? "Nữ" : child.gender}</span> : <span className="text-slate-300">—</span>}</td>
                        <td className="p-2 border border-slate-200"><span className="text-xs font-bold text-purple-700 bg-[#00A19A]/5 px-2 py-1 rounded-none border border-slate-300">{child.grade || "—"}</span></td>
                        <td className="p-2 text-xs font-semibold text-slate-600 border border-slate-200">{child.admissionCampus || "—"}</td>
                        <td className="p-2 border border-slate-200">{child.admissionResult ? <span className={`text-[10px] font-black px-2.5 py-1 rounded-none border ${child.admissionResult === "Học thử" ? "bg-[#00A19A]/5 text-[#00A19A] border-[#00A19A]/30" : child.admissionResult.toUpperCase().includes("ĐẠT") && !child.admissionResult.toUpperCase().includes("KHÔNG") ? "bg-emerald-50 text-emerald-800 border-emerald-300" : child.admissionResult.toUpperCase().includes("KHÔNG") ? "bg-rose-50 text-rose-800 border-rose-300" : "bg-amber-50 text-amber-800 border-amber-300"}`}>{child.admissionResult}</span> : <span className="text-xs text-slate-300">Chưa</span>}</td>
                        <td className="p-2 text-right border border-slate-200"><div className="flex justify-end gap-1"><button onClick={() => openEditChild(child)} className="p-2 text-slate-300 hover:text-[#00A19A] hover:bg-[#00A19A]/5 rounded-none transition-all"><Edit2 className="w-4 h-4" /></button><button onClick={() => setConfirm({ msg: `Xóa bé "${child.fullName}"?`, fn: () => doDeleteChild(child.id) })} className="p-2 text-slate-300 hover:text-rose-500 hover:bg-rose-50 transition-all text-xs font-semibold"><Trash2 className="w-4 h-4" /></button></div></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                          ...
                          .map((s, idx) => {
                            ...
                            return (
                              <tr key={s.id} className="hover:bg-[#F0FAF9] even:bg-slate-50/60 transition-colors duration-100 text-xs font-semibold">
                                ...
                                <td className="w-20 min-w-[80px] p-2 p-2 align-middle bg-inherit border border-slate-200"><span className="font-mono text-[10px] font-semibold text-[#00A19A] text-xs font-semibold">{s.studentCode}</span></td>
                                ...
                                <td className="w-28 min-w-[112px] p-2 p-2 align-middle bg-inherit border border-slate-200">
                                  <div className="flex flex-col gap-0.5">
                                    ...
                                    {s.resolvedAgeGroup && (
                                      <span className="text-[9px] font-medium text-[#00A19A] w-fit text-xs font-semibold">
                        ...
                        {studentSummaries
                          ...
                          .map((s, idx) => {
                            ...
                            const renderAreaCell = (areaCode: string, tdClass: string) => {
                              ...
                              let progressBg = "bg-[#00A19A]";
                              let progressTrack = "bg-teal-100";
                              let pillClass = "text-[#00A19A] bg-[#00A19A]/5 border-slate-300";
                              let headerIcon = "🧠";
                              ...
                              <tr key={s.id} className={`group border-b border-slate-200 hover:bg-[#F0FAF9] transition-colors duration-100 ${idx % 2 === 0 ? "bg-white" : "bg-slate-50/60"}`}>
                                 ...
                                 <td className="w-[200px] min-w-[200px] max-w-[200px] sticky left-10 z-10 shadow-[1px_0_0_0_#e2e8f0] whitespace-normal p-2 p-2 align-top bg-inherit border border-slate-200">
                                   <div className="flex flex-col gap-0.5 w-full">
                                     ...
                                     <div className="text-[9px] text-[#00A19A] font-mono font-bold">{s.studentCode}{s.grade ? <span className="text-slate-500 font-normal"> · {s.grade}</span> : null}</div>
                                    ...
                                    <div className="flex flex-col gap-1.5 w-full">
                                      {s.probationaryTeacher ? (
                                        ...
                                        <button
                                          ...
                                          className="inline-flex items-center justify-center gap-1 text-[10px] font-medium text-[#00A19A] hover:bg-teal-100 transition-colors w-full text-xs font-semibold"
                                        >
                                          Phân công
                                        </button>
                                      )}
            ...
            <h2 className="text-sm font-black text-slate-600 uppercase tracking-widest flex items-center gap-2"><Settings className="w-4 h-4 text-teal-400" /> Quản lý Tiêu chí &amp; Lĩnh vực Khảo sát</h2>
              ...
              <div className="flex gap-2 p-1 bg-slate-100 rounded-none w-fit mb-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-none text-sm font-bold transition-all ${devType === "INPUT" ? "bg-white text-[#00A19A] shadow-none" : "text-slate-500 hover:text-slate-700"}`}
                >
                ...
                {criteriaGrades.map(g => (
                  <button
                    ...
                    className={`px-4 py-2 text-[11px] font-bold rounded-none transition-all ${ageGroupFilter === g ? "bg-white text-violet-700 shadow-none border border-slate-300" : "text-slate-500 hover:text-[#00A19A]"}`}
                  >
                    {g}
                  </button>
                ))}
              ...
              {devType === "INPUT" && (() => {
                ...
                const renderGradeTags = (gradesStr: string, isPhase1: boolean) => {
                  ...
                  const tagBg = isPhase1 
                    ? "bg-[#00A19A]/5/60 text-teal-800 border-slate-300 hover:bg-teal-100/40" 
                ...
                return (
                  <div className="bg-gradient-to-br from-teal-50/40 via-white to-indigo-50/20 border border-slate-300/60 rounded-3xl p-5 shadow-none max-w-4xl my-4 hover:shadow-none transition-all duration-300 relative overflow-hidden animate-fadeIn">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                      {/* Giai đoạn 1 */}
                      <div className="bg-[#00A19A]/5/20 border border-slate-300/40 rounded-none p-4 flex flex-col justify-between hover:border-slate-300/60 transition-all">
                        <div>
                          <div className="flex items-center justify-between">
                            <span className="bg-[#00A19A]/10 text-[#00A19A] px-2.5 py-0.5 rounded-none text-[9px] font-extrabold uppercase tracking-wider border border-[#00A19A]/20">
                              Giai đoạn 1
                            </span>
                ...
                <div className="space-y-3">
                  {devAreas.map(area => (
                    <div key={area.id} className="bg-white rounded-none border border-slate-300 shadow-none overflow-hidden">
                      <div
                        className="px-4 py-3.5 flex items-center justify-between gap-3 cursor-pointer hover:bg-[#00A19A]/5/20 transition-all"
                      ...
                      {expAreaId === area.id && (
                        <div className="border-t border-slate-300 p-4 bg-[#00A19A]/5/10">
                          {(!area.criteria || area.criteria.length === 0) ? (
                            ...
                            <div className="overflow-x-auto bg-white border border-slate-300 rounded-none shadow-none">
                              <table className="w-full text-left border-collapse">
                                <thead className="bg-[#00A19A]/5/50 border-b border-slate-300">
                                  <tr>
                                ...
                                <tbody className="divide-y divide-teal-50">
                                  {area.criteria.map((crit, idx) => (
                                    <tr key={crit.id} className="hover:bg-[#00A19A]/5/30 transition-colors">
                                      <td className="p-2 text-slate-400 text-xs border border-slate-200">{idx + 1}</td>
                                      <td className="p-2 font-mono text-xs font-bold text-[#00A19A] border border-slate-200">{crit.code}</td>
                                      ...
                                      <td className="p-2 border border-slate-200"><span className="text-[10px] font-black text-[#00A19A] bg-[#00A19A]/5 px-2 py-0.5 rounded-none border border-[#00A19A]/20">{crit.ageGroup}</span></td>
                                      <td className="p-2 text-right border border-slate-200">
                                        <div className="flex gap-1">
                                          <button
                                            onClick={() => openEditCriteria(crit)}
                                            className="p-1.5 text-slate-300 hover:text-[#00A19A] hover:bg-[#00A19A]/5 rounded-none"
                                          >
          ...
          <div className="bg-white rounded-none border border-slate-300 shadow-none p-4 flex flex-wrap items-center gap-4">
            ...
            {rptBatchId !== "all" && (
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-bold text-[#00A19A] hover:bg-teal-100 transition-all disabled:opacity-50 cursor-pointer text-xs font-semibold"
              >
                {sendingBatchEmail ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Mail className="w-3.5 h-3.5" />}
                Thông báo GĐCS xét duyệt đợt
              </button>
            )}
            <button onClick={() => { setCPeriodId(rptPeriodId); fetchChildren(); }} className="flex items-center gap-1.5 text-sm font-bold text-[#00A19A] hover:bg-teal-100 text-xs font-semibold"><RefreshCw className="w-4 h-4" /> Cập nhật</button>
          </div>
                ...
                {rptStats.gradeStats.map(g => {
                  ...
                  return (
                    <div key={g.grade} className="space-y-1.5">
                      ...
                      <div className="w-full bg-[#00A19A]/5 h-3 rounded-none overflow-hidden border border-slate-200"><div className="h-full bg-[#00A19A] transition-all duration-700" style={{ width: `${pct}%` }} /></div>
                    </div>
                  );
                })}
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          <div className="lg:col-span-5 bg-white border border-slate-300 shadow-none rounded-3xl p-8 space-y-6">
            <div className="flex items-center gap-3 border-b pb-4 mb-2">
              <div className="w-10 h-10 bg-[#00A19A]/5 text-[#00A19A] rounded-none flex items-center justify-center">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5 ml-1">
                ...
                <button
                  ...
                  className="text-[10px] font-extrabold text-[#00A19A] hover:text-violet-700 hover:bg-teal-100 transition-all text-xs font-semibold"
                >
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  {rcLogo ? (
                    ...
                    <label className="w-16 h-16 rounded-none border-2 border-dashed border-slate-300 flex items-center justify-center text-slate-400 cursor-pointer hover:border-teal-400 hover:text-[#00A19A] transition-all">
            ...
            <button onClick={savePreschoolReportConfig} className="w-full py-4 bg-[#00A19A] hover:bg-[#00A19A]-700 text-white font-black text-xs uppercase tracking-widest rounded-none shadow-none shadow-teal-100 transition-all flex items-center justify-center gap-2">
          ...
          <div className="lg:col-span-7 shadow-inner p-8 flex flex-col min-h-[500px] text-xs font-semibold">
            <span className="text-[10px] font-black text-[#00A19A] uppercase tracking-widest mb-5">Xem trước mẫu thiết kế thực tế</span>
            ...
            {/* Info note */}
            <div className="mt-4 bg-[#00A19A]/5 border border-slate-300 rounded-none p-3">
      ...
      {/* Modal: Period */}
      <Modal open={pModal} onClose={() => setPModal(false)} title={editP ? "Sửa Kỳ" : "Tạo Kỳ mới"} footer={<><button onClick={() => setPModal(false)} className="flex-1 text-xs font-black uppercase text-slate-400 hover:text-slate-600">Hủy</button><button onClick={savePeriod} className="flex-1 py-3.5 bg-[#00A19A] text-white rounded-none text-xs font-black uppercase tracking-widest shadow-none shadow-teal-100">Lưu</button></>}>
        <div className="space-y-4">
      ...
      {/* Modal: Batch */}
      <Modal open={bModal} onClose={() => setBModal(false)} title={editB ? "Sửa Đợt" : "Thêm Đợt mới"} footer={<><button onClick={() => setBModal(false)} className="flex-1 text-xs font-black uppercase text-slate-400 hover:text-slate-600">Hủy</button><button onClick={saveBatch} className="flex-1 py-3.5 bg-[#00A19A] text-white rounded-none text-xs font-black uppercase tracking-widest shadow-none shadow-teal-100">Lưu</button></>}>
        <div className="space-y-4">
      ...
      <Modal open={cModal} onClose={() => setCModal(false)} title={editC ? "Sửa thông tin Bé" : "Thêm Bé Mầm non"} size="lg" footer={<><button onClick={() => setCModal(false)} className="flex-1 text-xs font-black uppercase text-slate-400">Đóng</button><button onClick={saveChild} className="flex-1 py-3.5 bg-[#00A19A] text-white rounded-none text-xs font-black uppercase tracking-widest shadow-none shadow-teal-100">Lưu</button></>}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Field label="Ngày sinh">
            ...
            />
            {ageInfo.months !== null && (
              <div className="text-[11px] font-black text-[#00A19A] mt-1.5 uppercase tracking-wider bg-[#00A19A]/5/50 rounded-none px-3 py-1.5 border border-slate-300 flex items-center gap-1.5 animate-in fade-in duration-200">
          ...
          <div className="bg-white rounded-3xl border border-slate-300 shadow-2xl max-w-2xl w-full overflow-hidden flex flex-col max-h-[90vh] animate-scale-up">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2 text-[10px] font-bold">
                        <button 
                          ...
                          className="text-[#00A19A] hover:text-violet-800 bg-[#00A19A]/5 px-2.5 py-1 rounded-none border border-slate-300 transition-colors cursor-pointer"
                        >
                          Chọn tất cả
                        </button>
                        <button 
                          ...
                          <div key={role} className="p-4 space-y-2">
                            <div className="flex items-center justify-between">
                              <span className={`text-[10px] font-black uppercase px-2.5 py-1 rounded-none border tracking-wider ${
                                ...
                                role === "BGH" ? "bg-teal-50 text-[#00A19A] border-teal-300" :
                                ...
                                role === "Giáo viên" ? "bg-[#00A19A]/5 text-[#00A19A] border border-[#00A19A]/30" :
                                ...
                                return (
                                  <label 
                                    ...
                                    className={`flex items-start gap-2.5 p-2 rounded-none border transition-all cursor-pointer select-none text-xs font-semibold ${
                                      r.checked 
                                        ? "bg-[#00A19A]/5/50 border-slate-300 text-violet-900 shadow-none" 
            ...
            <div className="p-4 flex items-center justify-end gap-3 text-xs font-semibold">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-6 py-2 text-xs font-black text-white bg-[#00A19A] hover:bg-[#00A19A]-700 rounded-none transition-all shadow-none shadow-teal-100 hover:shadow-violet-200 cursor-pointer"
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={"px-2 py-1 rounded-none text-[10px] font-bold border transition-all " + (isActive ? 'bg-[#00A19A]/10 border-indigo-200 text-indigo-700' : 'bg-slate-50 border-slate-300 text-slate-500 hover:bg-slate-100')}
                        >
                          + {p.label}
                        </button>
                      );
                    ...
                    <div className="flex items-center justify-between">
                      {studentCampusConfig?.logo ? (
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <svg className="w-6 h-6 text-[#00A19A]" viewBox="0 0 24 24" fill="currentColor">
      ...
      >
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-teal-50/30 via-indigo-50/10 to-purple-50/30 p-5 rounded-2xl border border-[#00A19A]/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6 shadow-xs">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 flex items-center justify-center text-[#00A19A] shadow-inner shrink-0 text-xs font-semibold">
                          ...
                          {isPhysical ? (
                            <>
                              ...
                              <input
                                ...
                                disabled={isAssessmentLocked}
                                className="mt-2.5 w-full text-xs font-semibold outline-none focus:border-[#00A19A] focus:bg-white focus:ring-2 focus:ring-[#00A19A]/10 transition-all disabled:bg-slate-100/50 disabled:cursor-not-allowed disabled:text-slate-500 text-xs font-semibold"
                              />
                            </>
                          ) : (
                            <>
              ...
              {(() => {
                ...
                const getCalcBadge = (res: string) => {
                  ...
                  if (res === "Đạt - Học Thử" || res === "Học thử") {
                    return <span className="text-xs font-black text-[#00A19A] flex items-center gap-1 shadow-xs animate-in fade-in text-xs font-semibold">★ ĐẠT - HỌC THỬ</span>;
                  }
                  if (res === "Đạt") {
        ...
        footer={
          <>
            ...
            <button
              ...
              className="flex-1 py-3.5 bg-[#00A19A] hover:bg-[#008c85] text-white rounded-none text-xs font-black uppercase tracking-widest shadow-none shadow-[#00A19A]/20 disabled:opacity-50 transition-all"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#00A19A]/5/50 p-4 rounded-none border border-slate-300 flex flex-wrap justify-between gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-purple-700 bg-[#00A19A]/5 px-2 py-0.5 rounded-none border border-slate-300">{probStudent?.grade}</p>
            </div>
            <div>
              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Cơ sở</p>
              <p className="text-sm font-bold text-indigo-700 bg-[#00A19A]/10 px-2 py-0.5 rounded-none border border-[#00A19A]/20">{probStudent?.admissionCampus || "—"}</p>
            </div>
          </div>
                                ...
                                <button
                                  ...
                                  className={`w-5 h-5 rounded-full border transition-all ${
                                    currentScore.result === "BAT_DAU_THE_HIEN"
                                      ? "bg-[#00A19A]/100 border-indigo-500 shadow-none text-white flex items-center justify-center text-[10px] font-bold mx-auto"
                                      : "border-slate-300 hover:border-slate-400 bg-white mx-auto block"
                                  }`}
                                >
                                  {currentScore.result === "BAT_DAU_THE_HIEN" && "✓"}
        ...
        footer={(
          <>
            ...
            <button
              ...
              className="flex-1 py-3.5 bg-[#00A19A] text-white rounded-none text-xs font-black uppercase tracking-widest"
            >
