...
function Spin() {
  return <div className="flex items-center justify-center py-16"><div className="relative"><div className="w-12 h-12 rounded-full border-4 border-slate-300 border-t-teal-600 animate-spin"></div><Baby className="w-5 h-5 text-[#00A99D] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" /></div></div>;
}
...
function ConfirmDialog({ open, onClose, onConfirm, message }: any) {
  if (!open) return null;
  return <div className="fixed inset-0 z-[9998] flex items-center justify-center bg-black/50 backdrop-blur-sm"><div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-sm text-center animate-in zoom-in-95 duration-200"><div className="w-14 h-14 flex items-center justify-center mx-auto mb-4 text-xs font-semibold"><AlertCircle className="w-7 h-7 text-rose-500" /></div><p className="font-black text-slate-800 text-base mb-6">{message}</p><div className="flex gap-3"><button onClick={onClose} className="flex-1 py-3 bg-slate-100 text-slate-600 font-black rounded-none hover:bg-slate-200 transition-all">Hủy</button><button onClick={() => { onConfirm(); onClose(); }} className="flex-1 text-white font-black hover:bg-rose-600 transition-all text-xs font-semibold">Xác nhận</button></div></div></div>;
}
...
function Field({ label, required, children }: any) {
  return <div className="space-y-1.5"><label className="block text-[11px] font-black text-slate-500 uppercase tracking-widest">{label}{required && <span className="text-[#00A99D] ml-1">*</span>}</label>{children}</div>;
}
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button onClick={fetchPeriods} className="p-2 text-slate-400 hover:text-[#00A99D] hover:bg-[#00A99D]/5 rounded-none transition-all"><RefreshCw className="w-4 h-4" /></button>
                ...
                <div key={p.id} className="bg-white rounded-none border border-slate-300 shadow-none overflow-hidden hover:border-slate-300 transition-all">
                  <div className="px-4 py-3.5 flex flex-wrap items-center justify-between gap-3 cursor-pointer" onClick={() => setExpandedId(expandedId === p.id ? null : p.id)}>
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <button onClick={e => { e.stopPropagation(); openEditPeriod(p); }} className="p-2 text-slate-400 hover:text-[#00A99D] hover:bg-[#00A99D]/5 rounded-none transition-all"><Edit2 className="w-4 h-4" /></button>
                                      ...
                                      <div className="flex items-center justify-between gap-2 group/assignee">
                                        ...
                                        {b.assignedUserId && (
                                          <button
                                            ...
                                            className="p-1 text-slate-400 hover:text-[#00A99D] hover:bg-[#00A99D]/5 rounded-md transition-all ml-2"
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-black text-slate-600 uppercase tracking-widest flex items-center gap-2">
              <UserCheck className="w-4 h-4 text-[#00A99D]" /> Phân công Giáo viên Khảo sát
            </h2>
            <div className="flex gap-2">
              <button 
                onClick={fetchAssignments} 
                className="p-2 text-slate-400 hover:text-[#00A99D] hover:bg-[#00A99D]/5 rounded-none transition-all"
              >
            ...
            <div className="lg:col-span-5 space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          {mappings.map((m, idx) => (
                            <div key={idx} className="grid grid-cols-12 gap-2 items-center bg-white border border-teal-50 px-3 py-2.5 rounded-none shadow-2xs hover:border-[#00A99D]/30 hover:shadow-xs transition-all duration-200">
                              ...
                              <span className="col-span-6 font-extrabold text-[#00A99D] text-[11px]">{m.actual}</span>
                            </div>
                          ))}
                        </div>
                      </div>
                        ...
                        return (
                          <label 
                            ...
                            className={`flex items-center gap-2.5 p-3 rounded-none border cursor-pointer transition-all ${
                              isChecked 
                                ? "bg-[#00A99D]/5 border-[#00A99D] text-[#00A99D] font-extrabold shadow-xs" 
                          ...
                          >
                            <input 
                              ...
                              className="w-4 h-4 rounded text-[#00A99D] focus:ring-teal-500 focus:ring-offset-0 cursor-pointer"
                            />
              ...
              <div className="bg-white rounded-3xl border border-slate-300 shadow-none p-5 space-y-4">
                <div className="flex items-center justify-between pb-2 border-b border-slate-300">
                  ...
                  <span className="text-[10px] bg-[#00A99D]/5 text-[#00A99D] px-2 py-0.5 rounded-none font-black">
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <input 
                              ...
                              className="w-4.5 h-4.5 rounded-none border-slate-300 text-[#00A99D] focus:ring-teal-500 focus:ring-offset-0 cursor-pointer"
                            />
                            <div>
                              <div className="text-sm font-bold text-slate-800 flex items-center gap-2">
                                <span>{t.teacherName}</span>
                                {t.departmentRel?.name && (
                                  <span className="text-[9px] font-black uppercase bg-[#00A99D]/5 text-[#00A99D] border border-slate-300 px-1.5 py-0.5 rounded-none tracking-wider">
                                    {t.departmentRel.name}
                                  </span>
                                )}
                              </div>
                          ...
                          {isChecked && <CheckCircle className="w-4.5 h-4.5 text-[#00A99D] animate-in zoom-in-50 duration-200" />}
                        </label>
                      );
                    })}
                </div>
                  ...
                  <div className="space-y-3">
                    {assignments.map((assign) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 text-[#00A99D] flex items-center justify-center font-black text-sm text-xs font-semibold">
                            ...
                            <div>
                              ...
                              <div className="flex gap-1.5 mt-1 items-center">
                                <span className="text-[9px] font-black uppercase bg-[#00A99D]/5 text-[#00A99D] border border-slate-300 px-2 py-0.5 rounded-none tracking-wider">
                                  {assign.grade}
                                </span>
                                {assign.batch && (
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
          <div className="bg-slate-100/80 backdrop-blur-md p-1.5 rounded-2xl flex gap-1.5 w-fit border border-slate-200 shadow-sm no-print mb-6">
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black tracking-tight transition-all duration-300 ${devTab === "assess" ? "bg-white text-[#00A99D] shadow-sm scale-[1.02]" : "text-slate-500 hover:text-slate-800"}`}
            >
            ...
            <button
              ...
              className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black tracking-tight transition-all duration-300 ${devTab === "xetDuyet" ? "bg-white text-[#00A99D] shadow-sm scale-[1.02]" : "text-slate-500 hover:text-slate-800"}`}
            >
              <CheckCircle2 className="w-3.5 h-3.5 text-[#00A99D]"/>
              Duyệt KQĐG
            </button>

            <button
              onClick={() => setDevTab("dgkqHocThu")}
              className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-black tracking-tight transition-all duration-300 ${devTab === "dgkqHocThu" ? "bg-white text-[#00A99D] shadow-sm scale-[1.02]" : "text-slate-500 hover:text-slate-800"}`}
            >
          ...
          {devTab === "assess" && (
            <div className="space-y-4">
              <div className="bg-white/80 backdrop-blur-md p-6 rounded-3xl shadow-sm border border-slate-200/60 grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-4 text-left items-end">
                <div className="group">
                  <label className="block text-xs font-bold tracking-widest uppercase mb-2 text-[#00A99D]/80 flex items-center gap-2 ml-1">
                ...
                <div className="group flex gap-2">
                  <button onClick={fetchStudentSummaries} className="h-9 px-4 text-xs font-black uppercase text-white bg-[#00A99D] hover:bg-[#008F89] rounded-2xl shadow-sm hover:shadow-md transition-all flex items-center gap-1.5 cursor-pointer">
                ...
                <div className="group xl:col-span-1">
                  ...
                  <div className="relative">
                    <input value={cSearch} onChange={e => setCSearch(e.target.value)} placeholder="Tên hoặc mã bé..." className="w-full bg-white border border-slate-200 rounded-2xl pl-10 pr-4 py-2 outline-none focus:border-[#00A99D] focus:ring-4 focus:ring-[#00A99D]/10 font-semibold text-slate-700 shadow-sm transition-all text-xs" />
                          ...
                          .map((s, idx) => {
                            ...
                            const statusBadge = () => {
                              if (s.totalCriteria > 0 && s.scoredCount > 0) {
                                return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-emerald-700 text-xs font-semibold">✓ Hoàn thành</span>;
                              }
                              ...
                              if (res && res !== "Chưa duyệt" && res !== "CHUA_DUYET" && res !== "") {
                                if (res === "Đạt - Miễn Học Thử" || res === "DAT_MIEN_HOC_THU") {
                                  return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-teal-700 text-xs font-semibold">✓ Miễn HT</span>;
                                }
                                ...
                                if (res === "Đạt" || res === "DAT") {
                                  return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-emerald-700 text-xs font-semibold">✓ Đạt</span>;
                                }
                                if (res === "Không đạt" || res === "KHONG_DAT") {
                                  return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-rose-700 text-xs font-semibold">✗ K.Đạt</span>;
                                }
                                if (res === "Ý kiến khác" || res === "Y_KIEN_KHAC") {
                                  return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-amber-700 text-xs font-semibold">Ý kiến</span>;
                                }
                              }
                              ...
                              if (s.scoredCount === s.totalCriteria) return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-emerald-700 text-xs font-semibold">✓ Hoàn thành</span>;
                              if (s.scoredCount > 0) return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-amber-700 text-xs font-semibold">✓ Hoàn thành</span>;
                            ...
                            return (
                              <tr key={s.id} className="hover:bg-[#F0FAF9] even:bg-slate-50/60 transition-colors duration-100 text-xs font-semibold">
                                <td className="w-10 min-w-[40px] max-w-[40px] sticky left-0 z-10 p-2 p-2 align-middle text-center text-[10px] text-slate-400 bg-inherit border border-slate-200">{idx + 1}</td>
                                ...
                                <td className="w-32 min-w-[128px] p-2 p-2 align-middle bg-inherit border border-slate-200">{statusBadge()}</td>
                                <td className="w-28 min-w-[112px] p-2 p-2 align-middle bg-inherit border border-slate-200">
                                  <button
                                    onClick={() => openEvaluation(s)}
                                    className="inline-flex items-center gap-1.5 text-[10px] font-medium text-violet-600 hover:bg-violet-100 transition-colors text-xs font-semibold"
                                  >
          ...
          {devTab === "xetDuyet" && (
            <div className="space-y-4">
              <div className="bg-white/80 backdrop-blur-md p-6 rounded-3xl shadow-sm border border-slate-200/60 grid grid-cols-1 md:grid-cols-3 xl:grid-cols-5 gap-4 text-left items-end">
                ...
                <div className="group">
                  <label className="block text-xs font-bold tracking-widest uppercase mb-2 text-[#00A99D]/80 flex items-center gap-2 ml-1">
                    <Sparkles className="w-3.5 h-3.5 text-[#00A99D]"/> Kết quả
                  </label>
                  <div className="relative">
                        ...
                        {studentSummaries
                          ...
                          .map((s, idx) => {
                            const getResultBadge = (res: string) => {
                              ...
                              if (res === "Đạt - Học Thử" || res === "DAT_HOC_THU" || res === "Học thử" || res === "HOC_THU") {
                                return <span className="inline-flex items-center gap-1 text-[10px] font-medium px-2.5 py-1 rounded-full bg-sky-100 text-sky-700">★ Học thử</span>;
                              }
                              if (res === "Đạt" || res === "DAT") {
                                return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-emerald-700 text-xs font-semibold">✓ Đạt</span>;
                              }
                              if (res === "Không đạt" || res === "KHONG_DAT") {
                                return <span className="inline-flex items-center gap-1 text-[10px] font-medium px-2.5 py-1 rounded-full bg-red-100 text-red-600">✗ K.Đạt</span>;
                              }
                              if (res === "Ý kiến khác" || res === "Y_KIEN_KHAC") {
                                return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-amber-700 text-xs font-semibold">Ý kiến</span>;
                              }
                            ...
                            const renderAreaCell = (areaCode: string, tdClass: string) => {
                              ...
                              let pillClass = "text-[#00A99D] bg-[#00A99D]/5 border-slate-300";
                              let headerIcon = "🧠";
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                      <div className={`border rounded-lg p-2.5 space-y-2 transition-all hover:scale-[1.01] hover:shadow-sm ${cardClass}`}>
                                        ...
                                        <div className="flex items-center justify-between gap-1 mt-1.5">
                                          <span className="text-[10px] font-bold text-emerald-700 flex items-center gap-1 shadow-sm text-xs font-semibold">
                                            <span className="w-1.5 h-1.5 text-xs font-semibold" /> {datCount}
                                          </span>
                                          <span className="text-[10px] font-bold text-rose-700 flex items-center gap-1 shadow-sm text-xs font-semibold">
                                            <span className="w-1.5 h-1.5 text-xs font-semibold" /> {khongDatCount}
                                          </span>
                                          {chuaDanhGiaCount > 0 && (
                            ...
                            return (
                              <tr key={s.id} className={`group border-b border-slate-200 hover:bg-[#F0FAF9] transition-colors duration-100 ${idx % 2 === 0 ? "bg-white" : "bg-slate-50/60"}`}>
                                  <td className="w-10 min-w-[40px] max-w-[40px] sticky left-0 z-10 p-2 p-2 align-middle text-center text-[10px] text-slate-300 bg-inherit border border-slate-200">{idx + 1}</td>
                                 <td className="w-[200px] min-w-[200px] max-w-[200px] sticky left-10 z-10 shadow-[1px_0_0_0_#e2e8f0] whitespace-normal p-2 p-2 align-top bg-inherit border border-slate-200">
                                   <div className="flex flex-col gap-0.5 w-full">
                                     <div className="font-semibold text-slate-800 text-[11px] leading-tight">{s.fullName}</div>
                                     <div className="text-[9px] text-[#00A99D] font-mono font-bold">{s.studentCode}{s.grade ? <span className="text-slate-500 font-normal"> · {s.grade}</span> : null}</div>
                                     ...
                                     <div className="text-[9px] text-slate-400 truncate" title={s.admissionCampus}>{s.admissionCampus || "—"}</div>
                                   </div>
                                </td>
                                ...
                                {/* Duyệt BGH MN */}
                                 {showBghSection && (
                                   <td className="w-[148px] min-w-[148px] whitespace-normal p-2 p-2 align-middle bg-inherit border border-slate-200">
                                     <div className="flex flex-col gap-0.5 w-full">
                                       {s.bghApprovalStatus ? (
                                         <>
                                           <div>
                                             {s.bghApprovalStatus === "DAT_MIEN_HOC_THU" && (
                                               <span className="inline-flex items-center gap-1 text-[10px] font-medium text-teal-700 text-xs font-semibold">✓ Miễn HT</span>
                                             )}
                                             {s.bghApprovalStatus === "DAT_HOC_THU" && (
                                               <span className="inline-flex items-center gap-1 text-[10px] font-medium px-2 py-0.5 rounded-md bg-sky-100 text-sky-700">★ Học thử</span>
                                             )}
                                             {s.bghApprovalStatus === "DAT" && (
                                               <span className="inline-flex items-center gap-1 text-[10px] font-medium text-emerald-700 text-xs font-semibold">✓ Đạt</span>
                                             )}
                                             {s.bghApprovalStatus === "KHONG_DAT" && (
                                               <span className="inline-flex items-center gap-1 text-[10px] font-medium text-rose-700 text-xs font-semibold">✗ K.Đạt</span>
                                             )}
                                             {s.bghApprovalStatus === "Y_KIEN_KHAC" && (
                                               <span className="inline-flex items-center gap-1 text-[10px] font-medium text-amber-700 text-xs font-semibold">Ý kiến</span>
                                             )}
                                           </div>
                                           ...
                                           {s.bghApprovalUser && <div className="text-[9px] text-slate-400">{s.bghApprovalUser}</div>}
                                         </>
                                       ) : (
                                         <span className="inline-flex items-center gap-1 text-[10px] text-slate-400">Chờ duyệt</span>
                                       )}
                                     </div>
                                   </td>
                                 )}
                                     ...
                                     <div className="flex flex-col gap-0.5 w-full">
                                       {s.gdcsApprovalStatus ? (
                                         <>
                                           ...
                                           {s.gdcsApprovalUser && <div className="text-[9px] text-slate-400">{s.gdcsApprovalUser}</div>}
                                         </>
                                       ) : (
                                         <span className="inline-flex items-center gap-1 text-[10px] text-slate-400">Chờ duyệt</span>
                                       )}
                                ...
                                <td className="w-[110px] min-w-[110px] p-2 p-2 align-middle bg-inherit border border-slate-200">{getResultBadge(s.generalResult)}</td>
                                <td className="w-[160px] min-w-[160px] p-2 p-2 align-top bg-inherit border border-slate-200">
                                    <div className="flex flex-col gap-1.5 w-full">
                                      {s.probationaryTeacher ? (
                                        ...
                                        <button
                                          ...
                                          className="inline-flex items-center justify-center gap-1 text-[10px] font-medium text-[#00A99D] hover:bg-teal-100 transition-colors w-full text-xs font-semibold"
                                        >
                                          Phân công
                                        </button>
                                      )}
                                ...
                                <td className="w-[180px] min-w-[180px] p-2 p-2 align-middle bg-inherit border border-slate-200">
                                        ...
                                        if (!hasBgh || !hasGdcs) {
                                          return (
                                            <button
                                                                                   ...
                                                                                   className="inline-flex items-center gap-1.5 text-[10px] font-medium text-amber-700 hover:bg-amber-100 disabled:opacity-50 transition-colors text-xs font-semibold"
                                                                                 >
              ...
              <div className="bg-white rounded-none border border-slate-300 shadow-none overflow-hidden">
                {sumLoading ? (
                  <div className="flex justify-center p-12">
                    <span className="text-[#00A99D] font-bold animate-pulse text-sm">Đang tải danh sách...</span>
                  </div>
                ) : studentSummaries.filter(s => {
                  const result = (s.admissionResult || "").toUpperCase();
                  return result.includes("HỌC THỬ") || result.includes("HOC_THU") || s.probationaryResult || s.probationaryClass;
                }).length === 0 ? (
                  <div className="text-center text-slate-400 font-semibold text-xs m-3 text-xs font-semibold">
                      ...
                      <tbody className="divide-y divide-slate-100/80">
                        {studentSummaries
                          ...
                          .map((s, idx) => {
                            ...
                            const resultBadge = () => {
                              if (isExempt) {
                                return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-teal-700 text-xs font-semibold">Miễn học thử</span>;
                              }
                              if (s.probationaryResult === "DAT") return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-emerald-700 text-xs font-semibold">✓ ĐẠT</span>;
                              if (s.probationaryResult === "CHUA_DAT") return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-rose-700 text-xs font-semibold">✗ CHƯA ĐẠT</span>;
                              return <span className="inline-flex items-center gap-1 text-[10px] font-medium px-2 py-0.5 rounded-md bg-slate-100 text-slate-400">Chưa đánh giá</span>;
                            };
          ...
          {devTab === "xuatThuChucMung" && (
            <div className="space-y-4">
              <div className="bg-white rounded-xl shadow-sm p-3 flex flex-wrap items-center gap-3">
                ...
                <button onClick={fetchStudentSummaries} className="flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-semibold text-white bg-[#00A99D] hover:bg-[#008F89] rounded-md transition-colors"><Search className="w-3.5 h-3.5" /> Tìm</button>
                          ...
                          .map((s, idx) => {
                            const resultBadge = () => {
                              if (s.probationaryResult === "DAT") {
                                return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-emerald-700 text-xs font-semibold">✓ ĐẠT - SAU HỌC THỬ</span>;
                              }
                              return <span className="inline-flex items-center gap-1 text-[10px] font-medium text-teal-700 text-xs font-semibold">✓ ĐẠT - MIỄN HỌC THỬ</span>;
                            };
                                ...
                                <td className="w-64 min-w-[256px] p-2 p-2 align-middle bg-inherit border border-slate-200">
                                  <div className="flex gap-2">
                                    <button
                                      ...
                                      className="inline-flex items-center gap-1.5 text-[10px] font-medium text-emerald-700 hover:bg-emerald-100 transition-colors whitespace-nowrap text-xs font-semibold"
                                    >
                                      <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5"><path strokeLinecap="round" strokeLinejoin="round" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/></svg>
                                      Xuất thư Chúc mừng
                                    </button>
                                    <button
                                      ...
                                      className="inline-flex items-center gap-1.5 text-[10px] font-medium text-amber-700 hover:bg-amber-100 transition-colors whitespace-nowrap text-xs font-semibold"
                                    >
                                    ...
                                    <button
                                      ...
                                      className="inline-flex items-center gap-1.5 text-[10px] font-medium text-violet-600 hover:bg-violet-100 transition-colors whitespace-nowrap cursor-pointer text-xs font-semibold"
                                    >
            ...
            <h2 className="text-sm font-black text-slate-600 uppercase tracking-widest flex items-center gap-2"><Settings className="w-4 h-4 text-teal-400" /> Quản lý Tiêu chí &amp; Lĩnh vực Khảo sát</h2>
              ...
              <div className="flex gap-2 p-1 bg-slate-100 rounded-none w-fit mb-2">
                <button
                  ...
                  className={`px-4 py-2 rounded-none text-sm font-bold transition-all ${devType === "INPUT" ? "bg-white text-[#00A99D] shadow-none" : "text-slate-500 hover:text-slate-700"}`}
                >
                ...
                {criteriaGrades.map(g => (
                  <button
                    ...
                    className={`px-4 py-2 text-[11px] font-bold rounded-none transition-all ${ageGroupFilter === g ? "bg-white text-violet-700 shadow-none border border-slate-300" : "text-slate-500 hover:text-[#00A99D]"}`}
                  >
                    {g}
                  </button>
                ))}
                                      ...
                                      <td className="p-2 text-right border border-slate-200">
                                        <div className="flex gap-1">
                                          <button
                                            ...
                                            className="p-1.5 text-slate-300 hover:text-[#00A99D] hover:bg-[#00A99D]/5 rounded-none"
                                          >
          ...
          <div className="bg-white rounded-none border border-slate-300 shadow-none p-4 flex flex-wrap items-center gap-4">
            ...
            {rptBatchId !== "all" && (
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-bold text-[#00A99D] hover:bg-teal-100 transition-all disabled:opacity-50 cursor-pointer text-xs font-semibold"
              >
                {sendingBatchEmail ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <Mail className="w-3.5 h-3.5" />}
                Thông báo GĐCS xét duyệt đợt
              </button>
            )}
            <button onClick={() => { setCPeriodId(rptPeriodId); fetchChildren(); }} className="flex items-center gap-1.5 text-sm font-bold text-[#00A99D] hover:bg-teal-100 text-xs font-semibold"><RefreshCw className="w-4 h-4" /> Cập nhật</button>
          </div>
                ...
                {rptStats.gradeStats.map(g => {
                  ...
                  return (
                    <div key={g.grade} className="space-y-1.5">
                      <div className="flex items-center justify-between text-sm"><span className="font-bold text-slate-700">{g.grade}</span><span className="font-black text-[#00A99D]">{g.count} trẻ ({pct}%)</span></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          <div className="lg:col-span-5 bg-white border border-slate-300 shadow-none rounded-3xl p-8 space-y-6">
            <div className="flex items-center gap-3 border-b pb-4 mb-2">
              <div className="w-10 h-10 bg-[#00A99D]/5 text-[#00A99D] rounded-none flex items-center justify-center">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5 ml-1">
                ...
                <button
                  ...
                  className="text-[10px] font-extrabold text-[#00A99D] hover:text-violet-700 hover:bg-teal-100 transition-all text-xs font-semibold"
                >
              ...
              <p className="text-[10px] text-slate-400 mt-1 font-semibold">
                Từ khóa tự điền: <span className="text-[#00A99D] font-bold">{"{{fullName}}"}</span>, <span className="text-[#00A99D] font-bold">{"{{grade}}"}</span>, <span className="text-[#00A99D] font-bold">{"{{admissionCampus}}"}</span>, <span className="text-[#00A99D] font-bold">{"{{academicYear}}"}</span>, <span className="text-[#00A99D] font-bold">{"{{surveyFormType}}"}</span>
              </p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-4">
                  {rcLogo ? (
                    ...
                    <label className="w-16 h-16 rounded-none border-2 border-dashed border-slate-300 flex items-center justify-center text-slate-400 cursor-pointer hover:border-teal-400 hover:text-[#00A99D] transition-all">
          ...
          <div className="lg:col-span-7 shadow-inner p-8 flex flex-col min-h-[500px] text-xs font-semibold">
            <span className="text-[10px] font-black text-[#00A99D] uppercase tracking-widest mb-5">Xem trước mẫu thiết kế thực tế</span>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="border-b border-slate-300 pb-2 mb-3">
                  {rcLogo ? (
                    ...
                    <span className="text-[10px] font-black tracking-tight text-[#00A99D] uppercase">SKY-LINE</span>
                  )}
                ...
                {rcFooter ? (
                  ...
                  <div className="border-t border-teal-500/30 pt-2 mt-2 text-[6px] text-slate-400">
                    <p className="text-center text-[#00A99D] font-bold">www.skylineschool.edu.vn • Hotline: (+84.236) 378 7777</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="mt-4 bg-[#00A99D]/5 border border-slate-300 rounded-none p-3">
              ...
              <p className="text-[10px] text-[#00A99D] mt-1">Cấu hình sẽ tự động được áp dụng khi xuất thư cho trẻ thuộc cơ sở <strong>{getCampusFullName(campuses.find(c => c.id === rcCampusId)?.campusName || "")}</strong>. Mỗi cơ sở có thể có cấu hình riêng.</p>
            </div>
          </div>
        </div>
      )}
      ...
      <Modal open={cModal} onClose={() => setCModal(false)} title={editC ? "Sửa thông tin Bé" : "Thêm Bé Mầm non"} size="lg" footer={<><button onClick={() => setCModal(false)} className="flex-1 text-xs font-black uppercase text-slate-400">Đóng</button><button onClick={saveChild} className="flex-1 py-3.5 bg-[#00A99D] text-white rounded-none text-xs font-black uppercase tracking-widest shadow-none shadow-teal-100">Lưu</button></>}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Field label="Ngày sinh">
            ...
            />
            {ageInfo.months !== null && (
              <div className="text-[11px] font-black text-[#00A99D] mt-1.5 uppercase tracking-wider bg-[#00A99D]/5/50 rounded-none px-3 py-1.5 border border-slate-300 flex items-center gap-1.5 animate-in fade-in duration-200">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2 text-[10px] font-bold">
                        <button 
                          ...
                          className="text-[#00A99D] hover:text-violet-800 bg-[#00A99D]/5 px-2.5 py-1 rounded-none border border-slate-300 transition-colors cursor-pointer"
                        >
                          Chọn tất cả
                        </button>
                        <button 
                          ...
                          <div key={role} className="p-4 space-y-2">
                            <div className="flex items-center justify-between">
                              <span className={`text-[10px] font-black uppercase px-2.5 py-1 rounded-none border tracking-wider ${
                                ...
                                role === "BGH" ? "bg-teal-50 text-[#00A99D] border-teal-300" :
                                ...
                                role === "Giáo viên" ? "bg-[#00A99D]/5 text-[#00A99D] border border-[#00A99D]/30" :
                                ...
                                return (
                                  ...
                                  >
                                    <input
                                      ...
                                      className="mt-0.5 rounded text-[#00A99D] focus:ring-teal-400 border-slate-300 w-3.5 h-3.5"
                                    />
                                    <div className="flex-1 min-w-0">
                                      <div className="font-bold truncate">{r.name}</div>
                                      <div className="text-[10px] text-slate-400 truncate mt-0.5">{r.email}</div>
                                      {r.info && <div className="text-[10px] text-[#00A99D] font-semibold truncate mt-0.5">🏫 {r.info}</div>}
                                    </div>
                                  </label>
                                );
                              })}
                        ...
                        >
                          <td className="p-2 text-center border border-slate-200" onClick={e => e.stopPropagation()}>
                            <input 
                              ...
                              className="rounded border-slate-300 text-[#00A99D] focus:ring-indigo-500 w-4 h-4 cursor-pointer"
                            />
                          </td>
...
<style>{`
          ...
          >
            ...
            <div className="flex items-center justify-between no-print text-xs font-semibold">
              <div className="flex items-center gap-2">
                {isInvitation ? <Mail className="w-5 h-5 text-[#00A99D]"/> : <GraduationCap className="w-5 h-5 text-[#00A99D]"/>}
              ...
              <div className="flex items-center gap-4">
                <button 
                  ...
                  className="hover:bg-emerald-700 text-white text-xs font-black uppercase tracking-wider shadow-none shadow-emerald-100 flex items-center gap-2 transition-all text-xs font-semibold"
                >
                  ...
                  <div className="flex flex-col gap-1 border-b pb-2 mb-3">
                    <div className="flex items-center justify-between">
                      {studentCampusConfig?.logo ? (
                        ...
                        <div className="flex items-center gap-1.5">
                          <span className="text-2xl font-black tracking-tight text-[#00A99D]" style={{ fontFamily: "Arial, sans-serif" }}>SKY-LINE</span>
                          <svg className="w-6 h-6 text-[#00A99D]" viewBox="0 0 24 24" fill="currentColor">
                ...
                {studentCampusConfig?.footer ? (
                  ...
                  <div className="w-full pt-2 z-10 print-footer" style={{ marginTop: "auto", width: "100%", boxSizing: "border-box", fontFamily: "Arial, sans-serif" }}>
                    ...
                    <div className="flex items-center gap-2 mb-2 w-full">
                      <span className="font-bold text-[#00A99D] whitespace-nowrap uppercase text-[9.5pt] tracking-wide">HỆ THỐNG GIÁO DỤC SKY-LINE</span>
                      <div className="flex-grow border-t border-[#00A99D]/70 h-0 mt-0.5"></div>
                      <span className="font-semibold text-[#00A99D] whitespace-nowrap lowercase text-[9pt]">www.skylineschool.edu.vn</span>
                    </div>
                    ...
                    <div className="flex flex-row justify-between w-full relative text-[7.5pt] text-slate-500 leading-tight">
                      ...
                      <div className="w-[32%] flex flex-col gap-1 text-left">
                        <div>
                          <p className="font-bold text-[#00A99D] text-[8pt]">SKY-LINE Riverside</p>
                          <p className="mt-0.5">Lô A2.4 Trần Đăng Ninh, Q. Hải Châu, TP. Đà Nẵng</p>
                        </div>
                        <div>
                          <p className="font-bold text-[#00A99D] text-[8pt]">SKY-LINE Central</p>
                      ...
                      <div className="w-[32%] flex flex-col gap-1 text-left">
                        <div>
                          <p className="font-bold text-[#00A99D] text-[8pt]">SKY-LINE Global</p>
                          <p className="mt-0.5">Lô A2 Trần Đăng Ninh, Q. Hải Châu, TP. Đà Nẵng</p>
                        </div>
                        <div>
                          <p className="font-bold text-[#00A99D] text-[8pt]">SKY-LINE Beach</p>
                      ...
                      <div className="w-[32%] flex flex-col gap-1 text-left">
                        <div>
                          <p className="font-bold text-[#00A99D] text-[8pt]">SKY-LINE Hill</p>
                      ...
                      <div className="absolute right-[-4px] top-[-4px] w-[50px] h-[38px] opacity-100 pointer-events-none flex items-center justify-center text-[#00A99D]">
