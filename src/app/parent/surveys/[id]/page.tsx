    ...
    return (
      <div className="min-h-[70vh] flex items-center justify-center px-4">
        <div className="bg-white p-12 text-center rounded-3xl shadow-xl shadow-emerald-100/50 border border-emerald-100 flex flex-col items-center max-w-lg w-full">
          ...
          <Link href="/parent/surveys" className="inline-flex items-center gap-2 px-8 py-3 bg-[#00A99D] text-white font-bold rounded-2xl hover:bg-[#009085] transition-all shadow-lg shadow-teal-500/20">
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
      ...
      <div className="text-center space-y-3">
        <Link href="/parent/surveys" className="inline-flex items-center gap-1.5 text-sm text-slate-400 hover:text-[#00A99D] transition-colors font-medium mb-2">
          <ArrowLeft className="w-4 h-4" />Quay lai
        </Link>
        <div className="inline-flex items-center gap-2 text-xs font-bold text-[#00A99D] uppercase tracking-wider text-xs font-semibold">
